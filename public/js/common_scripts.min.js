...
!function(t, e) {
    ...
    let t = 1e6
      ...
      , l = t=>{
        if (!t)
            return 0;
        let {transitionDuration: i, transitionDelay: s} = window.getComputedStyle(t)
          , n = Number.parseFloat(i)
          , a = Number.parseFloat(s);
        return n || a ? (i = i.split(",")[0],
        s = s.split(",")[0],
        (Number.parseFloat(i) + Number.parseFloat(s)) * e) : 0
    }
      , h = t=>{
    ...
    void 0 !== t.nodeType)
      , d = t=>c(t) ? t.jquery ? t[0] : t : "string" == typeof t && t.length > 0 ? document.querySelector(t) : null
      , u = t=>{
        if (!c(t) || 0 === t.getClientRects().length)
            return !1;
      ...
      , D = (t,e,i,s)=>{
        let n = t.length
          , a = t.indexOf(e);
        return -1 === a ? !i && s ? t[n - 1] : t[0] : (a += i ? 1 : -1,
        s && (a = (a + n) % n),
        t[Math.max(0, Math.min(a, n - 1))])
    }
      , C = /[^.]*(?=\..*)\.|.*/
      , x = /\..*/
      , S = /::\d+$/
    ...
    function z(t, e, i, s, n) {
        ...
        let u = E(r, e.replace(C, ""))
          , f = a ? F(t, i, r) : O(t, r);
        f.delegationSelector = a ? i : null,
        f.callable = r,
        f.oneOff = n,
        f.uidEvent = u,
        c[u] = f,
        t.addEventListener(o, f, a)
    }
    function H(t, e, i, s, n) {
        let a = Y(e[i], s, n);
        a && (t.removeEventListener(i, a, Boolean(n)),
        delete e[i][a.uidEvent])
    }
    function W(t, e, i, s) {
        let n = e[i] || {};
        for (let a of Object.keys(n))
            if (a.includes(s)) {
                let r = n[a];
                H(t, e, i, r.callable, r.delegationSelector)
            }
    }
    function N(t) {
        return M[t = t.replace(x, "")] || t
    }
    let R = {
        on(t, e, i, s) {
            z(t, e, i, s, !1)
        ...
        off(t, e, i, s) {
            ...
            for (let u of Object.keys(h)) {
                ...
                if (!o || e.includes(f)) {
                    let p = h[u];
                    H(t, l, r, p.callable, p.delegationSelector)
                }
            }
        },
        trigger(t, e, i) {
    ...
    let K = {
        ...
        getDataAttributes(t) {
            ...
            for (let s of i) {
                let n = s.replace(/^bs/, "");
                e[n = n.charAt(0).toLowerCase() + n.slice(1, n.length)] = V(t.dataset[s])
            }
            return e
        },
        getDataAttribute: (t,e)=>V(t.getAttribute(`data-bs-${U(e)}`))
    };
    class G {
        static get Default() {
            return {}
        ...
        _typeCheckConfig(t, e=this.constructor.DefaultType) {
            for (let i of Object.keys(e)) {
                let n = e[i]
                  ...
                  , r = c(a) ? "element" : s(a);
                if (!RegExp(n).test(r))
                    throw TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${i}" provided type "${r}" but expected type "${n}".`)
            }
        }
    }
    let X = "5.2.2";
    class Z extends G {
        ...
        static getInstance(t) {
            return q.get(d(t), this.DATA_KEY)
        }
    ...
    class tr extends Z {
        ...
        close() {
            let t = R.trigger(this._element, ti);
            if (t.defaultPrevented)
                return;
            this._element.classList.remove(ta);
            let e = this._element.classList.contains(tn);
            this._queueCallback(()=>this._destroyElement(), this._element, e)
        }
        _destroyElement() {
            this._element.remove(),
            R.trigger(this._element, ts),
            this.dispose()
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = tr.getOrCreateInstance(this);
                if ("string" == typeof t) {
    ...
    class tp extends Z {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = tp.getOrCreateInstance(this);
                "toggle" === t && e[t]()
            })
        }
    }
    R.on(document, tf, tu, t=>{
        t.preventDefault();
        let e = t.target.closest(tu)
          , i = tp.getOrCreateInstance(e);
        i.toggle()
    }
    ),
    w(tp);
    ...
    class tP extends G {
        ...
        _initEvents() {
            this._supportPointerEvents ? (R.on(this._element, ty, t=>this._start(t)),
            R.on(this._element, tw, t=>this._end(t)),
            this._element.classList.add(tD)) : (R.on(this._element, t8, t=>this._start(t)),
            R.on(this._element, t$, t=>this._move(t)),
            R.on(this._element, tb, t=>this._end(t)))
        }
        _eventIsPointerPenTouch(t) {
            return this._supportPointerEvents && (t.pointerType === tk || t.pointerType === t_)
        }
        static isSupported() {
    ...
    let tT = "carousel"
      ...
      , t1 = "active"
      , tV = "slide"
      , t2 = "carousel-item-end"
      , t7 = "carousel-item-start"
      , tU = "carousel-item-next"
      , t5 = "carousel-item-prev"
      , t4 = ".active"
      , t6 = ".carousel-item"
      , tK = t4 + t6
      , tG = ".carousel-item img"
      , tX = ".carousel-indicators"
      , tZ = "[data-bs-slide], [data-bs-slide-to]"
      , tQ = '[data-bs-ride="carousel"]'
      , tJ = {
        [tI]: tz,
        [tO]: tL
    }
    ...
    class ei extends Z {
        constructor(t, e) {
            ...
            this._indicatorsElement = tm.findOne(tX, this._element),
            this._addEventListeners(),
            this._config.ride === tq && this.cycle()
        }
        static get Default() {
            return et
        }
        ...
        _maybeEnableCycle() {
            if (this._config.ride) {
                if (this._isSliding) {
                    R.one(this._element, tW, ()=>this.cycle());
                    return
                }
                this.cycle()
            }
        ...
        to(t) {
            ...
            if (t > e.length - 1 || t < 0)
                return;
            if (this._isSliding) {
                R.one(this._element, tW, ()=>this.to(t));
                return
            }
        ...
        _addEventListeners() {
            this._config.keyboard && R.on(this._element, tN, t=>this._keydown(t)),
            "hover" === this._config.pause && (R.on(this._element, tR, ()=>this.pause()),
            R.on(this._element, t9, ()=>this._maybeEnableCycle())),
            this._config.touch && tP.isSupported() && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            for (let t of tm.find(tG, this._element))
                R.on(t, t3, t=>t.preventDefault());
            let e = ()=>{
                "hover" === this._config.pause && (this.pause(),
                this.touchTimeout && clearTimeout(this.touchTimeout),
                this.touchTimeout = setTimeout(()=>this._maybeEnableCycle(), tF + this._config.interval))
            }
              , i = {
                leftCallback: ()=>this._slide(this._directionToOrder(tL)),
                rightCallback: ()=>this._slide(this._directionToOrder(tz)),
                endCallback: e
            };
            this._swipeHelper = new tP(this._element,i)
        }
        _keydown(t) {
        ...
        _setActiveIndicatorElement(t) {
            if (!this._indicatorsElement)
                return;
            let e = tm.findOne(t4, this._indicatorsElement);
            e.classList.remove(t1),
            e.removeAttribute("aria-current");
            let i = tm.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement);
            i && (i.classList.add(t1),
        ...
        _slide(t, e=null) {
            ...
            let i = this._getActive()
              , s = t === t0
              , n = e || D(this._getItems(), i, s, this._config.wrap);
            if (n === i)
                return;
            let a = this._getItemIndex(n)
              , r = e=>R.trigger(this._element, e, {
                relatedTarget: n,
        ...
        _getActive() {
            return tm.findOne(tK, this._element)
        }
        _getItems() {
        ...
        _directionToOrder(t) {
            return y() ? t === tL ? tY : t0 : t === tL ? t0 : tY
        }
        _orderToDirection(t) {
            return y() ? t === tY ? tL : tz : t === tY ? tz : tL
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = ei.getOrCreateInstance(this, t);
                if ("number" == typeof t) {
                    e.to(t);
                    return
                }
    ...
    R.on(document, tB, tZ, function(t) {
        let e = o(this);
        if (!e || !e.classList.contains(tq))
            return;
        t.preventDefault();
        let i = ei.getOrCreateInstance(e)
    ...
    let es = "collapse"
      ...
      , em = "collapsed"
      , eg = `:scope .${ef} .${ef}`
      , ev = "collapse-horizontal"
      , e8 = "width"
      , e$ = "height"
      , eb = ".collapse.show, .collapse.collapsing"
      , ey = '[data-bs-toggle="collapse"]'
      , ew = {
        parent: null,
        toggle: !0
    }
    ...
    class ek extends Z {
        constructor(t, e) {
            ...
            for (let s of i) {
                let n = r(s)
                  , a = tm.find(n).filter(t=>t === this._element);
                null !== n && a.length && this._triggerArray.push(s)
            }
        ...
        show() {
            if (this._isTransitioning || this._isShown())
                return;
            let t = [];
            if (this._config.parent && (t = this._getFirstLevelChildren(eb).filter(t=>t !== this._element).map(t=>ek.getOrCreateInstance(t, {
                toggle: !1
            }))),
            t.length && t[0]._isTransitioning)
                return;
            let e = R.trigger(this._element, eo);
            ...
            let n = ()=>{
                ...
                this._element.classList.add(ef, eu),
                this._element.style[s] = "",
                R.trigger(this._element, el)
            }
        ...
        hide() {
            if (this._isTransitioning || !this._isShown())
                return;
            let t = R.trigger(this._element, eh);
            if (t.defaultPrevented)
                return;
            let e = this._getDimension();
            for (let i of (this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`,
            g(this._element),
            this._element.classList.add(ep),
            this._element.classList.remove(ef, eu),
            this._triggerArray)) {
                let s = o(i);
        ...
        _isShown(t=this._element) {
            return t.classList.contains(eu)
        }
        _configAfterMerge(t) {
        ...
        _getDimension() {
            return this._element.classList.contains(ev) ? e8 : e$
        }
        _initializeChildren() {
            if (!this._config.parent)
                return;
            let t = this._getFirstLevelChildren(ey);
            for (let e of t) {
                let i = o(e);
        ...
        static jQueryInterface(t) {
            ...
            this.each(function() {
                let i = ek.getOrCreateInstance(this, e);
                if ("string" == typeof t) {
                    if (void 0 === i[t])
                        throw TypeError(`No method named "${t}"`);
                    i[t]()
    ...
    R.on(document, ed, ey, function(t) {
        ("A" === t.target.tagName || t.delegateTarget && "A" === t.delegateTarget.tagName) && t.preventDefault();
        let e = r(this)
          , i = tm.find(e);
        for (let s of i)
            ek.getOrCreateInstance(s, {
                toggle: !1
            }).toggle()
    }),
    w(ek);
    var eD = "top"
      ...
      , eO = "popper"
      , eF = "reference"
      , e0 = eT.reduce(function(t, e) {
        return t.concat([e + "-" + eM, e + "-" + eA])
    }, [])
      , eY = [].concat(eT, [eP]).reduce(function(t, e) {
        return t.concat([e, e + "-" + eM, e + "-" + eA])
    }, [])
      , eL = "beforeRead"
      , ez = "read"
      , eH = "afterRead"
    ...
    function e2(t) {
        var e = e1(t).HTMLElement;
        return t instanceof e || t instanceof HTMLElement
    }
    function e7(t) {
        if ("undefined" == typeof ShadowRoot)
            return !1;
        var e = e1(t).ShadowRoot;
    ...
    function eU(t) {
        ...
        Object.keys(e.elements).forEach(function(t) {
            var i = e.styles[t] || {}
              , s = e.attributes[t] || {}
              , n = e.elements[t];
            e2(n) && eq(n) && (Object.assign(n.style, i),
    ...
    function e5(t) {
        ...
        function() {
            Object.keys(e.elements).forEach(function(t) {
                ...
                e2(s) && eq(s) && (Object.assign(s.style, a),
    ...
    function eQ() {
        return !/^((?!chrome|android).)*safari/i.test(eZ())
    }
    function eJ(t, e, i) {
        void 0 === e && (e = !1),
        void 0 === i && (i = !1);
        var s = t.getBoundingClientRect()
          , n = 1
          , a = 1;
        e && e2(t) && (n = t.offsetWidth > 0 && eX(s.width) / t.offsetWidth || 1,
        a = t.offsetHeight > 0 && eX(s.height) / t.offsetHeight || 1);
        var r = (eV(t) ? e1(t) : window).visualViewport
          , o = !eQ() && i
          , l = (s.left + (o && r ? r.offsetLeft : 0)) / n
          , h = (s.top + (o && r ? r.offsetTop : 0)) / a
          , c = s.width / n
          , d = s.height / a;
        return {
            width: c,
    ...
    function it(t) {
        var e = eJ(t)
          , i = t.offsetWidth
          , s = t.offsetHeight;
        return 1 >= Math.abs(e.width - i) && (i = e.width),
    ...
    function ii(t) {
        return e1(t).getComputedStyle(t)
    }
    function is(t) {
        return ["table", "td", "th"].indexOf(eq(t)) >= 0
    }
    function ia(t) {
        return ((eV(t) ? t.ownerDocument : t.document) || window.document).documentElement
    }
    function ir(t) {
        return "html" === eq(t) ? t : t.assignedSlot || t.parentNode || (e7(t) ? t.host : null) || ia(t)
    }
    function io(t) {
        return e2(t) && "fixed" !== ii(t).position ? t.offsetParent : null
    }
    function il(t) {
        var e = /firefox/i.test(eZ());
        if (/Trident/i.test(eZ()) && e2(t) && "fixed" === ii(t).position)
            return null;
        var i = ir(t);
        for (e7(i) && (i = i.host); e2(i) && 0 > ["html", "body"].indexOf(eq(i)); ) {
            var s = ii(i);
    ...
    function ih(t) {
        for (var e = e1(t), i = io(t); i && is(i) && "static" === ii(i).position; )
            i = io(i);
        return i && ("html" === eq(i) || "body" === eq(i) && "static" === ii(i).position) ? e : i || il(t) || e
    }
    function ic(t) {
    ...
    var iv = function t(e, i) {
        return im("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, i.rects, {
            placement: i.placement
        })) : e) ? e : ig(e, eT))
    };
    function i8(t) {
        var e, i = t.state, s = t.name, n = t.options, a = i.elements.arrow, r = i.modifiersData.popperOffsets, o = e6(i.placement), l = ic(o), h = [eS, ex].indexOf(o) >= 0 ? "height" : "width";
        if (a && r) {
            var c = iv(n.padding, i)
              , d = it(a)
              , u = "y" === l ? eD : eS
              , f = "y" === l ? eC : ex
              , p = i.rects.reference[h] + i.rects.reference[l] - r[l] - i.rects.popper[h]
    ...
    function i$(t) {
        ...
        null != s && ("string" != typeof s || (s = e.elements.popper.querySelector(s))) && ie(e.elements.popper, s) && (e.elements.arrow = s)
    }
    let ib = {
        name: "arrow",
        enabled: !0,
    ...
    function ik(t) {
        var e, i, s = t.popper, n = t.popperRect, a = t.placement, r = t.variation, o = t.offsets, l = t.position, h = t.gpuAcceleration, c = t.adaptive, d = t.roundOffsets, u = t.isFixed, f = o.x, p = void 0 === f ? 0 : f, m = o.y, g = void 0 === m ? 0 : m, v = "function" == typeof d ? d({
            x: p,
            y: g
        }) : {
            x: p,
        ...
        if (c) {
            var k = ih(s)
              ...
              , C = "clientWidth";
            k === e1(s) && (k = ia(s),
            "static" !== ii(k).position && "absolute" === l && (D = "scrollHeight",
            C = "scrollWidth")),
            (a === eD || (a === eS || a === ex) && r === eA) && (w = eC,
            g -= (u && k === _ && _.visualViewport ? _.visualViewport.height : k[D]) - n.height,
            g *= h ? 1 : -1),
            (a === eS || (a === eD || a === eC) && r === eA) && (y = ex,
            p -= (u && k === _ && _.visualViewport ? _.visualViewport.width : k[C]) - n.width,
            p *= h ? 1 : -1)
        }
        var x = Object.assign({
            position: l
        ...
        return (p = S.x,
        g = S.y,
        h) ? Object.assign({}, x, ((i = {})[w] = b ? "0" : "",
        i[y] = $ ? "0" : "",
        i.transform = 1 >= (_.devicePixelRatio || 1) ? "translate(" + p + "px, " + g + "px)" : "translate3d(" + p + "px, " + g + "px, 0)",
        i)) : Object.assign({}, x, ((e = {})[w] = b ? g + "px" : "",
        e[y] = $ ? p + "px" : "",
        e.transform = "",
        e))
    }
    function iD(t) {
        var e = t.state
          ...
          , h = {
            ...
            variation: iy(e.placement),
            popper: e.elements.popper,
            popperRect: e.rects.popper,
            gpuAcceleration: n,
            isFixed: "fixed" === e.options.strategy
        };
        null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, ik(Object.assign({}, h, {
            offsets: e.modifiersData.popperOffsets,
            position: e.options.strategy,
            adaptive: r,
            roundOffsets: l
        })))),
        null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, ik(Object.assign({}, h, {
    ...
    function iS(t) {
        var e = t.state
          ...
          , r = s.resize
          , o = void 0 === r || r
          , l = e1(e.elements.popper)
          , h = [].concat(e.scrollParents.reference, e.scrollParents.popper);
        return a && h.forEach(function(t) {
            t.addEventListener("scroll", i.update, ix)
        }),
        o && l.addEventListener("resize", i.update, ix),
        function() {
            a && h.forEach(function(t) {
                t.removeEventListener("scroll", i.update, ix)
            }),
            o && l.removeEventListener("resize", i.update, ix)
        }
    }
    let iP = {
        name: "eventListeners",
    ...
    function iO(t) {
        return eJ(ia(t)).left + iI(t).scrollLeft
    }
    function iF(t, e) {
        var i = e1(t)
          , s = ia(t)
    ...
    function i0(t) {
        var e, i = ia(t), s = iI(t), n = null == (e = t.ownerDocument) ? void 0 : e.body, a = eK(i.scrollWidth, i.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0), r = eK(i.scrollHeight, i.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0), o = -s.scrollLeft + iO(t), l = -s.scrollTop;
        return "rtl" === ii(n || i).direction && (o += eK(i.clientWidth, n ? n.clientWidth : 0) - a),
        {
            width: a,
            height: r,
            x: o,
    ...
    function iL(t) {
        return ["html", "body", "#document"].indexOf(eq(t)) >= 0 ? t.ownerDocument.body : e2(t) && iY(t) ? t : iL(ir(t))
    }
    function iz(t, e) {
        void 0 === e && (e = []);
        var i, s = iL(t), n = s === (null == (i = t.ownerDocument) ? void 0 : i.body), a = e1(s), r = n ? [a].concat(a.visualViewport || [], iY(s) ? s : []) : s, o = e.concat(r);
        return n ? o : o.concat(iz(ir(r)))
    }
    function iH(t) {
    ...
    function iN(t, e, i) {
        return e === eI ? iH(iF(t, i)) : eV(e) ? iW(e, i) : iH(i0(ia(t)))
    }
    function iR(t) {
        var e = iz(ir(t))
          , i = ["absolute", "fixed"].indexOf(ii(t).position) >= 0 && e2(t) ? ih(t) : t;
        return eV(i) ? e.filter(function(t) {
            return eV(t) && ie(t, i) && "body" !== eq(t)
        }) : []
    }
    function i9(t, e, i, s) {
        var n = [].concat("clippingParents" === e ? iR(t) : [].concat(e), [i])
          , a = n[0]
          , r = n.reduce(function(e, i) {
            var n = iN(t, i, s);
            return e.top = eK(n.top, e.top),
            e.right = eG(n.right, e.right),
            e.bottom = eG(n.bottom, e.bottom),
            e.left = eK(n.left, e.left),
            e
        }, iN(t, a, s));
    ...
    function i3(t) {
        var e, i = t.reference, s = t.element, n = t.placement, a = n ? e6(n) : null, r = n ? iy(n) : null, o = i.x + i.width / 2 - s.width / 2, l = i.y + i.height / 2 - s.height / 2;
        switch (a) {
        case eD:
            e = {
                x: o,
    ...
    function ij(t, e) {
        ...
        var i = e
          ...
          , m = i.padding
          , g = void 0 === m ? 0 : m
          , v = im("number" != typeof g ? g : ig(g, eT))
          , $ = u === eO ? eF : eO
          , b = t.rects.popper
          , y = t.elements[p ? $ : u]
          , w = i9(eV(y) ? y : y.contextElement || ia(t.elements.popper), l, c, r)
          , _ = eJ(t.elements.reference)
          , k = i3({
            reference: _,
            element: b,
            strategy: "absolute",
        ...
        if (u === eO && S) {
            ...
            Object.keys(x).forEach(function(t) {
                var e = [ex, eC].indexOf(t) >= 0 ? 1 : -1
                  , i = [eD, eC].indexOf(t) >= 0 ? "y" : "x";
                x[t] += P[i] * e
            })
        }
        return x
    ...
    function i1(t) {
        ...
        if (!e.modifiersData[s]._skip) {
            for (var n, a, r = i.mainAxis, o = void 0 === r || r, l = i.altAxis, h = void 0 === l || l, c = i.fallbackPlacements, d = i.padding, u = i.boundary, f = i.rootBoundary, p = i.altBoundary, m = i.flipVariations, g = void 0 === m || m, v = i.allowedAutoPlacements, $ = e.options.placement, b = e6($) === $, y = [$].concat(c || (b || !g ? [iM($)] : iq($))).reduce(function(t, i) {
                return t.concat(e6(i) === eP ? iB(e, {
                    placement: i,
                    boundary: u,
                    rootBoundary: f,
                    padding: d,
            ...
            }, []), w = e.rects.reference, _ = e.rects.popper, k = new Map, D = !0, C = y[0], x = 0; x < y.length; x++) {
                var S = y[x]
                  , P = e6(S)
                  , T = iy(S) === eM
                  , M = [eD, eC].indexOf(P) >= 0
            ...
            if (D)
                for (var Y = g ? 3 : 1, L = function t(e) {
                    ...
                    ;
            e.placement !== C && (e.modifiersData[s]._skip = !0,
            e.placement = C,
            e.reset = !0)
        }
    }
    ...
    function i7(t) {
        return [eD, ex, eC, eS].some(function(e) {
            return t[e] >= 0
        })
    }
    function iU(t) {
    ...
    function i6(t) {
        var e = t.state
          ...
          , n = i.offset
          , a = void 0 === n ? [0, 0] : n
          , r = eY.reduce(function(t, i) {
            return t[i] = i4(i, e.rects, a),
            t
        }, {})
          , o = r[e.placement]
          , l = o.x
    ...
    function iQ(t) {
        ...
        if (_) {
            if (a) {
                var T, M = "y" === y ? eD : eS, A = "y" === y ? eC : ex, E = "y" === y ? "height" : "width", I = _[y], O = I + g[M], F = I - g[A], Y = f ? -D[E] / 2 : 0, L = $ === eM ? k[E] : D[E], z = $ === eM ? -D[E] : -k[E], H = e.elements.arrow, W = f && H ? it(H) : {
                    width: 0,
                    height: 0
                }, N = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : ip(), R = N[M], j = N[A], B = id(0, k[E], W[E]), q = b ? k[E] / 2 - Y - B - R - x.mainAxis : L - B - R - x.mainAxis, V = b ? -k[E] / 2 + Y + B + j + x.mainAxis : z + B + j + x.mainAxis, U = e.elements.arrow && ih(e.elements.arrow), K = U ? "y" === y ? U.clientTop || 0 : U.clientLeft || 0 : 0, G = null != (T = null == S ? void 0 : S[y]) ? T : 0, X = I + q - G - K, Z = I + V - G, Q = id(f ? eG(O, X) : O, I, f ? eK(F, Z) : F);
                _[y] = Q,
                P[y] = Q - I
            }
            if (o) {
                var J, tt = "x" === y ? eD : eS, te = "x" === y ? eC : ex, ti = _[w], ts = "y" === w ? "height" : "width", tn = ti + g[tt], ta = ti - g[te], tr = -1 !== [eD, eS].indexOf(v), to = null != (J = null == S ? void 0 : S[w]) ? J : 0, tl = tr ? tn : ti - k[ts] - D[ts] - to + x.altAxis, th = tr ? ti + k[ts] + D[ts] - to - x.altAxis : ta, tc = f && tr ? iu(tl, ti, th) : id(f ? tl : tn, ti, f ? th : ta);
                _[w] = tc,
                P[w] = tc - ti
            }
            e.modifiersData[s] = P
    ...
    function se(t) {
        return t !== e1(t) && e2(t) ? st(t) : iI(t)
    }
    function si(t) {
        var e = t.getBoundingClientRect()
          , i = eX(e.width) / t.offsetWidth || 1
          , s = eX(e.height) / t.offsetHeight || 1;
        return 1 !== i || 1 !== s
    }
    function ss(t, e, i) {
        void 0 === i && (i = !1);
        ...
        return (s || !s && !i) && (("body" !== eq(e) || iY(a)) && (o = se(e)),
        e2(e) ? (l = eJ(e, !0),
        l.x += e.clientLeft,
        l.y += e.clientTop) : a && (l.x = iO(a))),
        {
            ...
            var r = {
              ...
              , h = {
                ...
                setOptions: function t(n) {
                    ...
                    d(),
                    r.options = Object.assign({}, a, r.options, o),
                    r.scrollParents = {
                        reference: eV(e) ? iz(e) : e.contextElement ? iz(e.contextElement) : [],
                        popper: iz(i)
                    };
                    var l = sa(so([].concat(s, r.options.modifiers)));
                ...
                forceUpdate: function t() {
                    if (!l) {
                        ...
                        if (sh(i, s)) {
                            r.rects = {
                                reference: ss(i, ih(s), "fixed" === r.options.strategy),
                                popper: it(s)
                            },
                            r.reset = !1,
    ...
    var sd = sc()
      ...
      , sp = [iP, iX, iC, e4, iK, iV, iJ, ib, i5]
      , sm = sc({
        defaultModifiers: sp
    });
    let sg = Object.freeze(Object.defineProperty({
        __proto__: null,
        popperGenerator: sc,
        detectOverflow: ij,
        createPopperBase: sd,
      ...
      , s0 = "dropup-center"
      , sY = "dropdown-center"
      , sL = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)'
      , sz = `${sL}.${sE}`
      , sH = ".dropdown-menu"
      , sW = ".navbar"
      , sN = ".navbar-nav"
      , sR = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)"
      , s9 = y() ? "top-end" : "top-start"
      , s3 = y() ? "top-start" : "top-end"
      , sj = y() ? "bottom-end" : "bottom-start"
      , sB = y() ? "bottom-start" : "bottom-end"
      , sq = y() ? "left-start" : "right-start"
      , s1 = y() ? "right-start" : "left-start"
      , sV = "top"
      , s2 = "bottom"
      , s7 = {
        autoClose: !0,
    ...
    class s5 extends Z {
        constructor(t, e) {
            ...
            this._menu = tm.next(this._element, sH)[0] || tm.prev(this._element, sH)[0] || tm.findOne(sH, this._parent),
        ...
        show() {
            ...
            let t = {
              ...
              , e = R.trigger(this._element, sS, t);
            if (!e.defaultPrevented) {
                if (this._createPopper(),
                "ontouchstart"in document.documentElement && !this._parent.closest(sN))
        ...
        _completeHide(t) {
            let e = R.trigger(this._element, sC, t);
            if (!e.defaultPrevented) {
                ...
                R.trigger(this._element, sx, t)
            }
        }
        _getConfig(t) {
            if ("object" == typeof (t = super._getConfig(t)).reference && !c(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
                throw TypeError(`${sv.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
            return t
        }
        _createPopper() {
            if (void 0 === sg)
            ...
            let t = this._element;
            "parent" === this._config.reference ? t = this._parent : c(this._config.reference) ? t = d(this._config.reference) : "object" == typeof this._config.reference && (t = this._config.reference);
        ...
        _getPlacement() {
            ...
            if (t.classList.contains(sF))
                return s1;
            if (t.classList.contains(s0))
                return sV;
            if (t.classList.contains(sY))
                return s2;
            let e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
            return t.classList.contains(sI) ? e ? s3 : s9 : e ? sB : sj
        }
        _detectNavbar() {
        ...
        _getPopperConfig() {
            ...
            return (this._inNavbar || "static" === this._config.display) && (K.setDataAttribute(this._menu, "popper", "static"),
            t.modifiers = [{
                name: "applyStyles",
                enabled: !1
            }]),
        ...
        _selectMenuItem({key: t, target: e}) {
            let i = tm.find(sR, this._menu).filter(t=>u(t));
            i.length && D(i, e, t === sk, !i.includes(e)).focus()
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = s5.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw TypeError(`No method named "${t}"`);
                    e[t]()
        ...
        static clearMenus(t) {
            if (t.button === sD || "keyup" === t.type && t.key !== sw)
                return;
            let e = tm.find(sz);
            for (let i of e) {
                let s = s5.getInstance(i);
                if (!s || !1 === s._config.autoClose)
                    continue;
                let n = t.composedPath()
                  , a = n.includes(s._menu);
                if (n.includes(s._element) || "inside" === s._config.autoClose && !a || "outside" === s._config.autoClose && a || s._menu.contains(t.target) && ("keyup" === t.type && t.key === sw || /input|select|option|textarea|form/i.test(t.target.tagName)))
                    continue;
                let r = {
        ...
        static dataApiKeydownHandler(t) {
            let e = /input|textarea/i.test(t.target.tagName)
              , i = t.key === sy
              , s = [s_, sk].includes(t.key);
            if (!s && !i || e && !i)
                return;
            t.preventDefault();
            let n = this.matches(sL) ? this : tm.prev(this, sL)[0] || tm.next(this, sL)[0] || tm.findOne(sL, t.delegateTarget.parentNode)
              , a = s5.getOrCreateInstance(n);
            if (s) {
                t.stopPropagation(),
                a.show(),
                a._selectMenuItem(t);
    ...
    R.on(document, sM, sL, s5.dataApiKeydownHandler),
    R.on(document, sM, sH, s5.dataApiKeydownHandler),
    R.on(document, sT, s5.clearMenus),
    R.on(document, sA, s5.clearMenus),
    R.on(document, sT, sL, function(t) {
        t.preventDefault(),
        s5.getOrCreateInstance(this).toggle()
    }),
    w(s5);
    let s4 = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top"
      , s6 = ".sticky-top"
      , sK = "padding-right"
      , sG = "margin-right";
    class sX {
        ...
        hide() {
            ...
            this._setElementAttributes(this._element, sK, e=>e + t),
            this._setElementAttributes(s4, sK, e=>e + t),
            this._setElementAttributes(s6, sG, e=>e - t)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"),
            this._resetElementAttributes(this._element, sK),
            this._resetElementAttributes(s4, sK),
            this._resetElementAttributes(s6, sG)
        }
        isOverflowing() {
        ...
        _applyManipulationCallback(t, e) {
            ...
            for (let i of tm.find(t, this._element))
                e(i)
        }
    }
    let sZ = "backdrop"
    ...
    class ns extends G {
        ...
        hide(t) {
            ...
            this._getElement().classList.remove(sJ),
            this._emulateAnimation(()=>{
                this.dispose(),
                _(t)
            }
        ...
        dispose() {
            this._isAppended && (R.off(this._element, nt),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
                ...
                this._config.isAnimated && t.classList.add(sQ),
                this._element = t
            }
            return this._element
        }
        _configAfterMerge(t) {
            return t.rootElement = d(t.rootElement),
            t
        }
        _append() {
            if (this._isAppended)
    ...
    class np extends G {
        ...
        activate() {
            ...
            R.off(document, nr),
            R.on(document, no, t=>this._handleFocusin(t)),
            R.on(document, nl, t=>this._handleKeydown(t)),
            this._isActive = !0)
        }
        deactivate() {
        ...
        _handleKeydown(t) {
            t.key === nh && (this._lastTabNavDirection = t.shiftKey ? nd : nc)
        }
    }
    let nm = "modal"
      , ng = "bs.modal"
      ...
      , nD = `resize${nv}`
      , nC = `click.dismiss${nv}`
      , nx = `mousedown.dismiss${nv}`
      , nS = `keydown.dismiss${nv}`
      , nP = `click${nv}${n8}`
      , nT = "modal-open"
      , nM = "fade"
      , nA = "show"
    ...
    class nz extends Z {
        constructor(t, e) {
            super(t, e),
            this._dialog = tm.findOne(nO, this._element),
            this._backdrop = this._initializeBackDrop(),
            this._focustrap = this._initializeFocusTrap(),
            this._isShown = !1,
            this._isTransitioning = !1,
            this._scrollBar = new sX,
            this._addEventListeners()
        }
        static get Default() {
            return nY
        ...
        show(t) {
            if (this._isShown || this._isTransitioning)
                return;
            let e = R.trigger(this._element, n_, {
                relatedTarget: t
            });
            !e.defaultPrevented && (this._isShown = !0,
            this._isTransitioning = !0,
        ...
        hide() {
            if (!this._isShown || this._isTransitioning)
                return;
            let t = R.trigger(this._element, nb);
            !t.defaultPrevented && (this._isShown = !1,
            this._isTransitioning = !0,
        ...
        dispose() {
            for (let t of [window, this._dialog])
                R.off(t, nv);
        ...
        _showElement(t) {
            ...
            let e = tm.findOne(nF, this._dialog);
            e && (e.scrollTop = 0),
            g(this._element),
            this._element.classList.add(nA);
            let i = ()=>{
                this._config.focus && this._focustrap.activate(),
                this._isTransitioning = !1,
                R.trigger(this._element, nk, {
                    relatedTarget: t
                })
            }
            ;
        ...
        _addEventListeners() {
            ...
            R.on(this._element, nx, t=>{
                R.one(this._element, nC, e=>{
        ...
        _hideModal() {
            ...
            this._isTransitioning = !1,
            this._backdrop.hide(()=>{
                document.body.classList.remove(nT),
                this._resetAdjustments(),
                this._scrollBar.reset(),
                R.trigger(this._element, nw)
            }
            )
        }
        _isAnimated() {
        ...
        _triggerBackdropTransition() {
            let t = R.trigger(this._element, ny);
            if (t.defaultPrevented)
                return;
            let e = this._element.scrollHeight > document.documentElement.clientHeight
              , i = this._element.style.overflowY;
            !("hidden" === i || this._element.classList.contains(nE)) && (e || (this._element.style.overflowY = "hidden"),
        ...
        static jQueryInterface(t, e) {
            return this.each(function() {
                let i = nz.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === i[t])
                        throw TypeError(`No method named "${t}"`);
                    i[t](e)
    ...
    R.on(document, nP, n0, function(t) {
        let e = o(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        R.one(e, n_, t=>{
            !t.defaultPrevented && R.one(e, nw, ()=>{
                u(this) && this.focus()
            }
            )
        }
        ...
        let i = tm.findOne(nI);
        i && nz.getInstance(i).hide();
        let s = nz.getOrCreateInstance(e);
        s.toggle(this)
    }),
    Q(nz),
    w(nz);
    let nH = "offcanvas"
      ...
      , n6 = `resize${nN}`
      , nK = `click${nN}${nR}`
      , nG = `keydown.dismiss${nN}`
      , nX = '[data-bs-toggle="offcanvas"]'
      , nZ = {
        backdrop: !0,
        keyboard: !0,
        scroll: !1
    ...
    class nJ extends Z {
        ...
        show(t) {
            if (this._isShown)
                return;
            let e = R.trigger(this._element, n2, {
                relatedTarget: t
            });
            if (e.defaultPrevented)
                return;
            this._isShown = !0,
            this._backdrop.show(),
            this._config.scroll || new sX().hide(),
            this._element.setAttribute("aria-modal", !0),
            this._element.setAttribute("role", "dialog"),
            this._element.classList.add(nB);
            let i = ()=>{
                (!this._config.scroll || this._config.backdrop) && this._focustrap.activate(),
                this._element.classList.add(nj),
                this._element.classList.remove(nB),
                R.trigger(this._element, n7, {
                    relatedTarget: t
                })
            }
            ;
        ...
        hide() {
            if (!this._isShown)
                return;
            let t = R.trigger(this._element, nU);
            if (t.defaultPrevented)
                return;
            this._focustrap.deactivate(),
            this._element.blur(),
            ...
            this._backdrop.hide();
            let e = ()=>{
                this._element.classList.remove(nj, nq),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
                this._config.scroll || new sX().reset(),
                R.trigger(this._element, n4)
            }
            ;
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = nJ.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
                        throw TypeError(`No method named "${t}"`);
                    e[t](this)
    ...
    R.on(document, nK, nX, function(t) {
        let e = o(this);
        ...
        let i = tm.findOne(nV);
        i && i !== e && nJ.getInstance(i).hide();
        let s = nJ.getOrCreateInstance(e);
        s.toggle(this)
    }),
    R.on(window, n9, ()=>{
        for (let t of tm.find(nV))
            nJ.getOrCreateInstance(t).show()
    }
    ),
    R.on(window, n6, ()=>{
        for (let t of tm.find("[aria-modal][class*=show][class*=offcanvas-]"))
            "fixed" !== getComputedStyle(t).position && nJ.getOrCreateInstance(t).hide()
    }
    ),
    Q(nJ),
    w(nJ);
    let at = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      , ae = /^aria-[\w-]*$/i
      , ai = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i
      , as = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i
      , an = (t,e)=>{
        let i = t.nodeName.toLowerCase();
        return e.includes(i) ? !at.has(i) || Boolean(ai.test(t.nodeValue) || as.test(t.nodeValue)) : e.filter(t=>t instanceof RegExp).some(t=>t.test(i))
    }
      , aa = {
        "*": ["class", "dir", "id", "lang", "role", ae],
    ...
    function ar(t, e, i) {
        ...
        for (let r of a) {
            ...
            let l = [].concat(...r.attributes)
              , h = [].concat(e["*"] || [], e[o] || []);
            for (let c of l)
                an(c, h) || r.removeAttribute(c.nodeName)
        }
        return n.body.innerHTML
    }
    let ao = "TemplateFactory"
      , al = {
        allowList: aa,
        content: {},
        extraClass: "",
    ...
    class ad extends G {
        ...
        _setContent(t, e, i) {
            ...
            if (s) {
                ...
                if (c(e)) {
                    this._putElementInTemplate(d(e), s);
                    return
                }
    ...
    let au = "tooltip"
      , af = new Set(["sanitize", "allowList", "sanitizeFn"])
      , ap = "fade"
      , am = "modal"
      , ag = "show"
      , av = ".tooltip-inner"
    ...
    class a0 extends Z {
        ...
        dispose() {
            ...
            R.off(this._element.closest(a8), a$, this._hideModalHandler),
        ...
        show() {
            ...
            if (!(this._isWithContent() && this._isEnabled))
                return;
            let t = R.trigger(this._element, this.constructor.eventName(aC))
              , e = p(this._element)
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(s),
            R.trigger(this._element, this.constructor.eventName(aS))),
            this._popper ? this._popper.update() : this._popper = this._createPopper(s),
            s.classList.add(ag),
            "ontouchstart"in document.documentElement)
                for (let a of [].concat(...document.body.children))
                    R.on(a, "mouseover", m);
            let r = ()=>{
                R.trigger(this._element, this.constructor.eventName(ax)),
        ...
        hide() {
            if (!this._isShown())
                return;
            let t = R.trigger(this._element, this.constructor.eventName(ak));
            if (t.defaultPrevented)
                return;
            let e = this._getTipElement();
            if (e.classList.remove(ag),
            "ontouchstart"in document.documentElement)
                for (let i of [].concat(...document.body.children))
                    R.off(i, "mouseover", m);
            this._activeTrigger[aw] = !1,
            this._activeTrigger[ay] = !1,
            this._activeTrigger[ab] = !1,
            this._isHovered = null;
            let s = ()=>{
                !this._isWithActiveTrigger() && (this._isHovered || e.remove(),
                this._element.removeAttribute("aria-describedby"),
                R.trigger(this._element, this.constructor.eventName(aD)),
                this._disposePopper())
            }
            ;
        ...
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new ad({
                ...this._config,
                content: t,
        ...
        _isAnimated() {
            return this._config.animation || this.tip && this.tip.classList.contains(ap)
        }
        _isShown() {
            return this.tip && this.tip.classList.contains(ag)
        }
        _createPopper(t) {
        ...
        _setListeners() {
            ...
            for (let e of t)
                if ("click" === e)
                    R.on(this._element, this.constructor.eventName(aP), this._config.selector, t=>{
                        let e = this._initializeOnDelegatedTarget(t);
                        e.toggle()
                    }
                    );
                else if (e !== a_) {
                    let i = e === ab ? this.constructor.eventName(aA) : this.constructor.eventName(aT)
                      , s = e === ab ? this.constructor.eventName(aE) : this.constructor.eventName(aM);
                    R.on(this._element, i, this._config.selector, t=>{
                        let e = this._initializeOnDelegatedTarget(t);
                        e._activeTrigger["focusin" === t.type ? ay : ab] = !0,
                        e._enter()
                    }
                    ),
                    R.on(this._element, s, this._config.selector, t=>{
                        let e = this._initializeOnDelegatedTarget(t);
                        e._activeTrigger["focusout" === t.type ? ay : ab] = e._element.contains(t.relatedTarget),
                        e._leave()
                    }
                    )
                }
            ...
            ,
            R.on(this._element.closest(a8), a$, this._hideModalHandler)
        }
        _fixTitle() {
        ...
        _configAfterMerge(t) {
            return t.container = !1 === t.container ? document.body : d(t.container),
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = a0.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class aN extends a0 {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                let e = aN.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class rt extends Z {
        ...
        _configAfterMerge(t) {
            return t.target = d(t.target) || document.body,
            t.rootMargin = t.offset ? `${t.offset}px 0px -30%` : t.rootMargin,
            "string" == typeof t.threshold && (t.threshold = t.threshold.split(",").map(t=>Number.parseFloat(t))),
            t
        }
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (R.off(this._config.target, aq),
            R.on(this._config.target, aq, aU, t=>{
        ...
        _observerCallback(t) {
            ...
            for (let a of (this._previousScrollData.parentScrollTop = s,
            t)) {
                if (!a.isIntersecting) {
                    this._activeTarget = null,
        ...
        _initializeTargetsAndObservables() {
            this._targetLinks = new Map,
            this._observableSections = new Map;
            let t = tm.find(aU, this._config.target);
            for (let e of t) {
                if (!e.hash || f(e))
                    continue;
                let i = tm.findOne(e.hash, this._element);
                u(i) && (this._targetLinks.set(e.hash, e),
        ...
        _process(t) {
            ...
            R.trigger(this._element, aB, {
                relatedTarget: t
            }))
        }
        _activateParents(t) {
            if (t.classList.contains(aV)) {
                tm.findOne(aZ, t.closest(aX)).classList.add(a2);
                return
            }
            for (let e of tm.parents(t, a5))
                for (let i of tm.prev(e, aG))
                    i.classList.add(a2)
        }
        _clearActiveClass(t) {
            t.classList.remove(a2);
            let e = tm.find(`${aU}.${a2}`, t);
            for (let i of e)
                i.classList.remove(a2)
        }
        static jQueryInterface(t) {
            return this.each(function() {
                let e = rt.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
                        throw TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    R.on(window, a1, ()=>{
        for (let t of tm.find(a7))
            rt.getOrCreateInstance(t)
    }
    ),
    w(rt);
    let re = "tab"
      ...
      , r$ = ".dropdown-toggle"
      , rb = ".dropdown-menu"
      , ry = ":not(.dropdown-toggle)"
      , rw = '.list-group, .nav, [role="tablist"]'
      , r_ = ".nav-item, .list-group-item"
      , rk = `.nav-link${ry}, .list-group-item${ry}, [role="tab"]${ry}`
      , rD = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]'
      , rC = `${rk}, ${rD}`
      , rx = `.${rm}[data-bs-toggle="tab"], .${rm}[data-bs-toggle="pill"], .${rm}[data-bs-toggle="list"]`;
    class rS extends Z {
        constructor(t) {
            if (super(t),
            this._parent = this._element.closest(rw),
            !this._parent)
                return;
            this._setInitialAttributes(this._parent, this._getChildren()),
            R.on(this._element, rh, t=>this._keydown(t))
        }
        static get NAME() {
            return re
        }
        show() {
            ...
            !s.defaultPrevented && (!i || !i.defaultPrevented) && (this._deactivate(e, t),
            this._activate(t, e))
        }
        _activate(t, e) {
            if (!t)
            ...
            ;
            this._queueCallback(i, t, t.classList.contains(rg))
        }
        _deactivate(t, e) {
            if (!t)
                return;
        ...
        _keydown(t) {
            if (![rd, ru, rf, rp].includes(t.key))
                return;
            t.stopPropagation(),
            t.preventDefault();
            let e = [ru, rp].includes(t.key)
              , i = D(this._getChildren().filter(t=>!f(t)), t.target, e, !0);
            i && (i.focus({
                preventScroll: !0
            }),
        ...
        _getChildren() {
            return tm.find(rC, this._parent)
        }
        _getActiveElem() {
        ...
        _getInnerElement(t) {
            return t.matches(rC) ? t : tm.findOne(rC, t)
        }
        _getOuterElement(t) {
            return t.closest(r_) || t
        }
        static jQueryInterface(t) {
            return this.each(function() {
    ...
    R.on(document, rl, rD, function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        !f(this) && rS.getOrCreateInstance(this).show()
    }),
    R.on(window, rc, ()=>{
        for (let t of tm.find(rx))
            rS.getOrCreateInstance(t)
    }
    ),
    w(rS);
    let rP = "toast"
    ...
    class r3 extends Z {
        ...
        show() {
            let t = R.trigger(this._element, rY);
            if (t.defaultPrevented)
                return;
            this._clearTimeout(),
            this._config.animation && this._element.classList.add(rz);
            let e = ()=>{
                this._element.classList.remove(rN),
                R.trigger(this._element, rL),
                this._maybeScheduleHide()
            }
            ;
            this._element.classList.remove(rH),
            g(this._element),
            this._element.classList.add(rW, rN),
            this._queueCallback(e, this._element, this._config.animation)
        }
        hide() {
            if (!this.isShown())
                return;
            let t = R.trigger(this._element, rF);
            if (t.defaultPrevented)
                return;
            let e = ()=>{
                this._element.classList.add(rH),
                this._element.classList.remove(rN, rW),
                R.trigger(this._element, r0)
            }
            ;
        ...
        dispose() {
            this._clearTimeout(),
            this.isShown() && this._element.classList.remove(rW),
            super.dispose()
        }
        isShown() {
        ...
        _setListeners() {
            R.on(this._element, rA, t=>this._onInteraction(t, !0)),
            R.on(this._element, rE, t=>this._onInteraction(t, !1)),
            R.on(this._element, rI, t=>this._onInteraction(t, !0)),
            R.on(this._element, rO, t=>this._onInteraction(t, !1))
        }
        _clearTimeout() {
            clearTimeout(this._timeout),
            this._timeout = null
...
function(t, e) {
    function i(e, i) {
        ...
        if ("area" === n) {
            var a, r = e.parentNode, o = r.name;
            return !!e.href && !!o && "map" === r.nodeName.toLowerCase() && !!(a = t("img[usemap=#" + o + "]")[0]) && s(a)
        }
        ...
        zIndex: function(i) {
            ...
            if (this.length)
                for (var s, n, a = t(this[0]); a.length && a[0] !== document; ) {
                    if (("absolute" === (s = a.css("position")) || "relative" === s || "fixed" === s) && (n = parseInt(a.css("zIndex"), 10),
                    !isNaN(n) && 0 !== n))
                        return n;
                    a = a.parent()
                }
    ...
    t("<a>").outerWidth(1).jquery || t.each(["Width", "Height"], function(i, s) {
        function n(e, i, s, n) {
            return t.each(a, function() {
                ...
                s && (i -= parseFloat(t.curCSS(e, "border" + this + "Width", !0)) || 0),
                n && (i -= parseFloat(t.curCSS(e, "margin" + this, !0)) || 0)
            }),
            i
        }
    ...
    t.extend(t.ui, {
        ...
        isOver: function(e, i, s, n, a, r) {
            return t.ui.isOverAxis(e, s, a) && t.ui.isOverAxis(i, n, r)
        }
    }))
}(jQuery),
function(t, e) {
    ...
    t.widget.bridge = function(i, s) {
        t.fn[i] = function(n) {
            var a = "string" == typeof n
              ...
              , o = this;
            return n = !a && r.length ? t.extend.apply(null, [!0, n].concat(r)) : n,
            a && "_" === n.charAt(0) || (a ? this.each(function() {
                var s = t.data(this, i)
                  , a = s && t.isFunction(s[n]) ? s[n].apply(s, r) : s;
                if (a !== s && a !== e)
                    return o = a,
                    !1
            }) : this.each(function() {
    ...
    t.Widget.prototype = {
        ...
        _createWidget: function(e, i) {
            ...
            this.element = t(i),
            this.options = t.extend(!0, {}, this.options, this._getCreateOptions(), e);
            var s = this;
        ...
        _setOption: function(t, e) {
            ...
            "disabled" === t && this.widget()[e ? "addClass" : "removeClass"](this.widgetBaseClass + "-disabled ui-state-disabled").attr("aria-disabled", e),
            this
        },
        enable: function() {
        ...
        _trigger: function(e, i, s) {
            ...
            !(t.isFunction(r) && !1 === r.call(this.element[0], i, s) || i.isDefaultPrevented())
        }
    }
}(jQuery),
function(t, e) {
    ...
    t.widget("ui.mouse", {
        ...
        _mouseDown: function(e) {
            if (!i) {
                ...
                return !(n && !a && this._mouseCapture(e)) || ((this.mouseDelayMet = !this.options.delay,
        ...
        _mouseMove: function(e) {
            return !t.browser.msie || document.documentMode >= 9 || e.button ? this._mouseStarted ? (this._mouseDrag(e),
...
function(t, e) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        _mouseCapture: function(e) {
            ...
            !!this.handle && (i.iframeFix && t(!0 === i.iframeFix ? "iframe" : i.iframeFix).each(function() {
        ...
        _mouseStop: function(e) {
            ...
            for (var s = this.element[0], n = !1; s && (s = s.parentNode); )
                s == document && (n = !0);
            if (!n && "original" === this.options.helper)
                return !1;
        ...
        _getParentOffset: function() {
            ...
            return "absolute" == this.cssPosition && this.scrollParent[0] != document && t.ui.contains(this.scrollParent[0], this.offsetParent[0]) && (e.left += this.scrollParent.scrollLeft(),
        ...
        _setContainment: function() {
            var e = this.options;
            if ("parent" == e.containment && (e.containment = this.helper[0].parentNode),
        ...
        _convertPositionTo: function(e, i) {
            ...
            var s = "absolute" == e ? 1 : -1
              , n = (this.options,
            "absolute" != this.cssPosition || this.scrollParent[0] != document && t.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent)
              , a = /(html|body)/i.test(n[0].tagName);
            return {
                top: i.top + this.offset.relative.top * s + this.offset.parent.top * s - (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : n.scrollTop()) * s),
                left: i.left + this.offset.relative.left * s + this.offset.parent.left * s - (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : n.scrollLeft()) * s)
            }
        },
        _generatePosition: function(e) {
            var i, s = this.options, n = "absolute" != this.cssPosition || this.scrollParent[0] != document && t.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, a = /(html|body)/i.test(n[0].tagName), r = e.pageX, o = e.pageY;
            if (this.originalPosition) {
                if (this.containment) {
                    if (this.relative_container) {
                        ...
                        i = this.containment;
                    e.pageX - this.offset.click.left < i[0] && (r = i[0] + this.offset.click.left),
                    e.pageY - this.offset.click.top < i[1] && (o = i[1] + this.offset.click.top),
                    e.pageX - this.offset.click.left > i[2] && (r = i[2] + this.offset.click.left),
                    e.pageY - this.offset.click.top > i[3] && (o = i[3] + this.offset.click.top)
                }
                if (s.grid) {
                    var h = s.grid[1] ? this.originalPageY + Math.round((o - this.originalPageY) / s.grid[1]) * s.grid[1] : this.originalPageY;
                    o = i && (h - this.offset.click.top < i[1] || h - this.offset.click.top > i[3]) ? h - this.offset.click.top < i[1] ? h + s.grid[1] : h - s.grid[1] : h;
            ...
            return {
                top: o - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : n.scrollTop()),
                left: r - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (t.browser.safari && t.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : n.scrollLeft())
            }
        },
        _clear: function() {
    ...
    t.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(e, i) {
            var s = t(this).data("draggable")
              , n = s.options
              , a = !1;
            s.scrollParent[0] != document && "HTML" != s.scrollParent[0].tagName ? ((!n.axis || "x" != n.axis) && (s.overflowOffset.top + s.scrollParent[0].offsetHeight - e.pageY < n.scrollSensitivity ? s.scrollParent[0].scrollTop = a = s.scrollParent[0].scrollTop + n.scrollSpeed : e.pageY - s.overflowOffset.top < n.scrollSensitivity && (s.scrollParent[0].scrollTop = a = s.scrollParent[0].scrollTop - n.scrollSpeed)),
            (!n.axis || "y" != n.axis) && (s.overflowOffset.left + s.scrollParent[0].offsetWidth - e.pageX < n.scrollSensitivity ? s.scrollParent[0].scrollLeft = a = s.scrollParent[0].scrollLeft + n.scrollSpeed : e.pageX - s.overflowOffset.left < n.scrollSensitivity && (s.scrollParent[0].scrollLeft = a = s.scrollParent[0].scrollLeft - n.scrollSpeed))) : ((!n.axis || "x" != n.axis) && (e.pageY - t(document).scrollTop() < n.scrollSensitivity ? a = t(document).scrollTop(t(document).scrollTop() - n.scrollSpeed) : t(window).height() - (e.pageY - t(document).scrollTop()) < n.scrollSensitivity && (a = t(document).scrollTop(t(document).scrollTop() + n.scrollSpeed))),
            (!n.axis || "y" != n.axis) && (e.pageX - t(document).scrollLeft() < n.scrollSensitivity ? a = t(document).scrollLeft(t(document).scrollLeft() - n.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < n.scrollSensitivity && (a = t(document).scrollLeft(t(document).scrollLeft() + n.scrollSpeed)))),
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i) {
            for (var s = t(this).data("draggable"), n = s.options, a = n.snapTolerance, r = i.offset.left, o = r + s.helperProportions.width, l = i.offset.top, h = l + s.helperProportions.height, c = s.snapElements.length - 1; c >= 0; c--) {
                var d = s.snapElements[c].left
                  , u = d + s.snapElements[c].width
                  , f = s.snapElements[c].top
                  , p = f + s.snapElements[c].height;
                if (!(d - a < r && r < u + a && f - a < l && l < p + a || d - a < r && r < u + a && f - a < h && h < p + a || d - a < o && o < u + a && f - a < l && l < p + a || d - a < o && o < u + a && f - a < h && h < p + a)) {
                ...
                !s.snapElements[c].snapping && (m || g || v || $ || b) && s.options.snap.snap && s.options.snap.snap.call(s.element, e, t.extend(s._uiHash(), {
                    snapItem: s.snapElements[c].item
                })),
                s.snapElements[c].snapping = m || g || v || $ || b
            }
        }
    }),
...
function(t, e) {
    t.widget("ui.droppable", {
        ...
        destroy: function() {
            for (var e = t.ui.ddmanager.droppables[this.options.scope], i = 0; i < e.length; i++)
    ...
    t.ui.intersect = function(e, i, s) {
        ...
        var n = (e.positionAbs || e.position.absolute).left
          ...
          , o = r + e.helperProportions.height
          , l = i.offset.left
        ...
        switch (s) {
        case "fit":
            return l <= n && a <= h && c <= r && o <= d;
        case "intersect":
            return l < n + e.helperProportions.width / 2 && a - e.helperProportions.width / 2 < h && c < r + e.helperProportions.height / 2 && o - e.helperProportions.height / 2 < d;
        case "pointer":
            var u = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left
              , f = (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top;
            return t.ui.isOver(f, u, c, l, i.proportions.height, i.proportions.width);
        case "touch":
            return (r >= c && r <= d || o >= c && o <= d || r < c && o > d) && (n >= l && n <= h || a >= l && a <= h || n < l && a > h);
        default:
            return !1
        }
    }
    ...
    t.ui.ddmanager = {
            ...
            g: for (var r = 0; r < s.length; r++)
                if (!s[r].options.disabled && (!e || s[r].accept.call(s[r].element[0], e.currentItem || e.element))) {
                    for (var o = 0; o < a.length; o++)
                        if (a[o] == s[r].element[0]) {
                            s[r].proportions.height = 0;
                            continue g
                        }
                    s[r].visible = "none" != s[r].element.css("display"),
                    s[r].visible && ("mousedown" == n && s[r]._activate.call(s[r], i),
        ...
        drag: function(e, i) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s, n = t.ui.intersect(e, this, this.options.tolerance), a = n || 1 != this.isover ? n && 0 == this.isover ? "isover" : null : "isout";
                    if (a) {
                        if (this.options.greedy) {
                            var r = this.element.parents(":data(droppable):eq(0)");
                            r.length && ((s = t.data(r[0], "droppable")).greedyChild = "isover" == a ? 1 : 0)
                        }
                        s && "isover" == a && (s.isover = 0,
                        s.isout = 1,
                        s._out.call(s, i)),
                        this[a] = 1,
        ...
        dragStop: function(e, i) {
            e.element.parents(":not(body,html)").unbind("scroll.droppable"),
            e.options.refreshPositions || t.ui.ddmanager.prepareOffsets(e, i)
        }
    }
}(jQuery),
function(t, e) {
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function() {
            ...
            this.handles = i.handles || (t(".ui-resizable-handle", this.element).length ? {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
            ...
            this.handles.constructor == String) {
                ...
                for (var n = 0; n < s.length; n++) {
                    var a = t.trim(s[n])
                      , r = t('<div class="ui-resizable-handle ui-resizable-' + a + '"></div>');
                    r.css({
                        zIndex: i.zIndex
                    }),
            ...
            this._handles.mouseover(function() {
                if (!e.resizing) {
                    if (this.className)
                        var t = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i);
                    e.axis = t && t[1] ? t[1] : "se"
                }
            }),
            i.autoHide && (this._handles.hide(),
            t(this.element).addClass("ui-resizable-autohide").hover(function() {
                i.disabled || (t(this).removeClass("ui-resizable-autohide"),
                e._handles.show())
            }, function() {
                !i.disabled && (e.resizing || (t(this).addClass("ui-resizable-autohide"),
                e._handles.hide()))
            })),
            this._mouseInit()
        },
        ...
        _mouseCapture: function(e) {
            ...
            for (var s in this.handles)
                t(this.handles[s])[0] == e.target && (i = !0);
        ...
        _mouseStart: function(e) {
            ...
            var r = i(this.helper.css("left"))
              , o = i(this.helper.css("top"));
            s.containment && (r += t(s.containment).scrollLeft() || 0,
            o += t(s.containment).scrollTop() || 0),
        ...
        _mouseDrag: function(e) {
            ...
            if (!o)
                return !1;
            var l = o.apply(this, [e, a, r]);
            return t.browser.msie && t.browser.version,
            this.sizeDiff,
        ...
        _mouseStop: function(e) {
            ...
            if (this._helper) {
                var n = this._proportionallyResizeElements
                  ...
                  , r = a && t.ui.hasScroll(n[0], "left") ? 0 : s.sizeDiff.height
                  , o = a ? 0 : s.sizeDiff.width
                  , l = {
        ...
        _updateVirtualBoundaries: function(t) {
            var e, i, n, a, r, o = this.options;
            r = {
                minWidth: s(o.minWidth) ? o.minWidth : 0,
                maxWidth: s(o.maxWidth) ? o.maxWidth : 1 / 0,
                minHeight: s(o.minHeight) ? o.minHeight : 0,
                maxHeight: s(o.maxHeight) ? o.maxHeight : 1 / 0
            },
        ...
        _updateRatio: function(t, e) {
            ...
            "sw" == a && (t.left = i.left + (n.width - t.width),
            t.top = null),
            "nw" == a && (t.top = i.top + (n.height - t.height),
            t.left = i.left + (n.width - t.width)),
            t
        },
        _respectSize: function(t, e) {
            this.helper;
            var i = this._vBoundaries
              , n = (this._aspectRatio || e.shiftKey,
            this.axis)
              , a = s(t.width) && i.maxWidth && i.maxWidth < t.width
              , r = s(t.height) && i.maxHeight && i.maxHeight < t.height
              , o = s(t.width) && i.minWidth && i.minWidth > t.width
              , l = s(t.height) && i.minHeight && i.minHeight > t.height;
            o && (t.width = i.minWidth),
            l && (t.height = i.minHeight),
            a && (t.width = i.maxWidth),
            r && (t.height = i.maxHeight);
            var h = this.originalPosition.left + this.originalSize.width
              , c = this.position.top + this.size.height
              , d = /sw|nw|w/.test(n)
              , u = /nw|ne|n/.test(n);
            o && d && (t.left = h - i.minWidth),
            a && d && (t.left = h - i.maxWidth),
            l && u && (t.top = c - i.minHeight),
            r && u && (t.top = c - i.maxHeight);
            var f = !t.width && !t.height;
            return f && !t.left && t.top ? t.top = null : f && !t.top && t.left && (t.left = null),
            t
        },
    ...
    t.ui.plugin.add("resizable", "alsoResize", {
        start: function(e, i) {
            ...
            "object" != typeof s.alsoResize || s.alsoResize.parentNode ? n(s.alsoResize) : s.alsoResize.length ? (s.alsoResize = s.alsoResize[0],
            n(s.alsoResize)) : t.each(s.alsoResize, function(t) {
                n(t)
            })
        },
        resize: function(e, i) {
    ...
    t.ui.plugin.add("resizable", "animate", {
        stop: function(e, i) {
            var s = t(this).data("resizable")
              ...
              , o = r && t.ui.hasScroll(a[0], "left") ? 0 : s.sizeDiff.height
    ...
    t.ui.plugin.add("resizable", "containment", {
        start: function(e, s) {
            var n = t(this).data("resizable")
              ...
              , r = n.element
              , o = a.containment
              , l = o instanceof t ? o.get(0) : /parent/.test(o) ? r.parent().get(0) : o;
            if (l) {
                if (n.containerElement = t(l),
                /document/.test(o) || o == document)
                    ...
                    var d = n.containerOffset
                      ...
                      , p = t.ui.hasScroll(l, "left") ? l.scrollWidth : f
                      , m = t.ui.hasScroll(l) ? l.scrollHeight : u;
                    n.parentData = {
                        element: l,
                        left: d.left,
                        top: d.top,
        ...
        resize: function(e, i) {
            ...
            s.containerOffset)
              , r = (s.size,
            s.position)
              , o = s._aspectRatio || e.shiftKey
              , l = {
                top: 0,
                left: 0
            }
              , h = s.containerElement;
            h[0] != document && /static/.test(h.css("position")) && (l = a),
            r.left < (s._helper ? a.left : 0) && (s.size.width = s.size.width + (s._helper ? s.position.left - a.left : s.position.left - l.left),
            o && (s.size.height = s.size.width / s.aspectRatio),
            s.position.left = n.helper ? a.left : 0),
            r.top < (s._helper ? a.top : 0) && (s.size.height = s.size.height + (s._helper ? s.position.top - a.top : s.position.top),
            o && (s.size.width = s.size.height * s.aspectRatio),
            ...
            var c = Math.abs((s._helper,
            s.offset.left - l.left + s.sizeDiff.width))
              ...
              , f = /relative|absolute/.test(s.containerElement.css("position"));
            u && f && (c -= s.parentData.left),
            c + s.size.width >= s.parentData.width && (s.size.width = s.parentData.width - c,
            o && (s.size.height = s.size.width / s.aspectRatio)),
            d + s.size.height >= s.parentData.height && (s.size.height = s.parentData.height - d,
            o && (s.size.width = s.size.height * s.aspectRatio))
        },
        stop: function(e, i) {
            var s = t(this).data("resizable")
            ...
            s.containerOffset)
              ...
              , o = s.containerElement
              , l = t(s.helper)
              , h = l.offset()
              , c = l.outerWidth() - s.sizeDiff.width
              , d = l.outerHeight() - s.sizeDiff.height;
            s._helper && !n.animate && /relative/.test(o.css("position")) && t(this).css({
                left: h.left - r.left - a.left,
                width: c,
                height: d
            }),
            s._helper && !n.animate && /static/.test(o.css("position")) && t(this).css({
                left: h.left - r.left - a.left,
                width: c,
                height: d
            })
    ...
    t.ui.plugin.add("resizable", "grid", {
        resize: function(e, i) {
            ...
            var h = Math.round((a.width - r.width) / (n.grid[0] || 1)) * (n.grid[0] || 1)
              , c = Math.round((a.height - r.height) / (n.grid[1] || 1)) * (n.grid[1] || 1);
            /^(se|s|e)$/.test(l) ? (s.size.width = r.width + h,
            s.size.height = r.height + c) : /^(ne)$/.test(l) ? (s.size.width = r.width + h,
            s.size.height = r.height + c,
            s.position.top = o.top - c) : /^(sw)$/.test(l) ? (s.size.width = r.width + h,
            s.size.height = r.height + c,
            s.position.left = o.left - h) : (s.size.width = r.width + h,
            s.size.height = r.height + c,
            s.position.top = o.top - c,
            s.position.left = o.left - h)
        }
    });
    var i = function(t) {
            ...
            !this.options.disabled) {
                ...
                this.selectees.each(function() {
                    ...
                    if (l && l.element != i.element[0]) {
                        var h = !1;
                        "touch" == s.tolerance ? h = !(l.left > r || l.right < n || l.top > o || l.bottom < a) : "fit" == s.tolerance && (h = l.left > n && l.right < r && l.top > a && l.bottom < o),
                        h ? (l.selected && (l.$element.removeClass("ui-selected"),
                        l.selected = !1),
...
function(t, e) {
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _setOption: function(e, i) {
            ...
            this.widget()[i ? "addClass" : "removeClass"]("ui-sortable-disabled")) : t.Widget.prototype._setOption.apply(this, arguments)
        },
        _mouseCapture: function(e, i) {
            ...
            if (t(e.target).parents().each(function() {
                if (t.data(this, s.widgetName + "-item") == a)
                    return n = t(this),
                    !1
            }),
            t.data(e.target, s.widgetName + "-item") == a && (n = t(e.target)),
            !n)
                return !1;
        ...
        _mouseStart: function(e, i, s) {
            ...
            n.cursor && (t("body").css("cursor") && (this._storedCursor = t("body").css("cursor")),
            t("body").css("cursor", n.cursor)),
            ...
            !s)
                for (var r = this.containers.length - 1; r >= 0; r--)
                    this.containers[r]._trigger("activate", e, a._uiHash(this));
        ...
        _mouseDrag: function(e) {
            ...
            this.options.scroll) {
                ...
                e.pageX - t(document).scrollLeft() < i.scrollSensitivity ? s = t(document).scrollLeft(t(document).scrollLeft() - i.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < i.scrollSensitivity && (s = t(document).scrollLeft(t(document).scrollLeft() + i.scrollSpeed))),
            ...
            for (var n = this.items.length - 1; n >= 0; n--) {
                var a = this.items[n]
                  , r = a.item[0]
                  , o = this._intersectsWithPointer(a);
                if (o && r != this.currentItem[0] && this.placeholder[1 == o ? "next" : "prev"]()[0] != r && !t.ui.contains(this.placeholder[0], r) && ("semi-dynamic" != this.options.type || !t.ui.contains(this.element[0], r))) {
                    if (this.direction = 1 == o ? "down" : "up",
                    "pointer" == this.options.tolerance || this._intersectsWithSides(a))
                        this._rearrange(e, a);
                    else
                        break;
        ...
        cancel: function() {
            ...
            if (this.dragging) {
                ...
                for (var i = this.containers.length - 1; i >= 0; i--)
                    this.containers[i]._trigger("deactivate", null, e._uiHash(this)),
        ...
        _intersectsWithPointer: function(e) {
            ...
            return !!n && (this.floating ? r && "right" == r || "down" == a ? 2 : 1 : a && ("down" == a ? 2 : 1))
        },
        ...
        _getItemsAsjQuery: function(e) {
            ...
            if (n && e)
                for (var a = n.length - 1; a >= 0; a--)
                    for (var r = t(n[a]), o = r.length - 1; o >= 0; o--) {
                        var l = t.data(r[o], this.widgetName);
        ...
        _removeCurrentsFromItems: function() {
            for (var t = this.currentItem.find(":data(" + this.widgetName + "-item)"), e = 0; e < this.items.length; e++)
                for (var i = 0; i < t.length; i++)
                    t[i] == this.items[e].item[0] && this.items.splice(e, 1)
        },
        _refreshItems: function(e) {
            this.items = [],
            this.containers = [this];
            var i = this.items
              , s = [[t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {
                item: this.currentItem
                ...
                for (var a = n.length - 1; a >= 0; a--)
                    for (var r = t(n[a]), o = r.length - 1; o >= 0; o--) {
                        ...
                        l && l != this && !l.options.disabled && (s.push([t.isFunction(l.options.items) ? l.options.items.call(l.element[0], e, {
                            item: this.currentItem
                        }) : t(l.options.items, l.element), l]),
                        this.containers.push(l))
                    }
            for (var a = s.length - 1; a >= 0; a--)
                for (var h = s[a][1], c = s[a][0], o = 0, d = c.length; o < d; o++) {
                    var u = t(c[o]);
                    u.data(this.widgetName + "-item", h),
                    i.push({
                        item: u,
                        instance: h,
                        width: 0,
            ...
            if (!s.placeholder || s.placeholder.constructor == String) {
                ...
                s.placeholder = {
                    element: function() {
                        ...
                        return n || (e.style.visibility = "hidden"),
                        e
                    },
                    update: function(t, e) {
        ...
        _contactContainers: function(e) {
            for (var i = null, s = null, n = this.containers.length - 1; n >= 0; n--)
                if (!t.ui.contains(this.currentItem[0], this.containers[n].element[0])) {
                    if (this._intersectsWith(this.containers[n].containerCache)) {
                        if (i && t.ui.contains(this.containers[n].element[0], i.element[0]))
                            continue;
                        i = this.containers[n],
                        s = n
                    } else
            ...
            if (i) {
                if (1 === this.containers.length)
                    ...
                    for (var a = 1e4, r = null, o = this.positionAbs[this.containers[s].floating ? "left" : "top"], l = this.items.length - 1; l >= 0; l--)
                        if (t.ui.contains(this.containers[s].element[0], this.items[l].item[0])) {
                            ...
                            Math.abs(h - o) < a && (a = Math.abs(h - o),
                            r = this.items[l],
                            this.direction = h - o > 0 ? "down" : "up")
                        }
                    if (!r && !this.options.dropOnEmpty)
                        return;
                    this.currentContainer = this.containers[s],
                    r ? this._rearrange(e, r, null, !0) : this._rearrange(e, null, this.containers[s].element, !0),
                    this._trigger("change", e, this._uiHash()),
        ...
        _convertPositionTo: function(e, i) {
            ...
            "absolute" != this.cssPosition || this.scrollParent[0] != document && t.ui.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent)
              , a = /(html|body)/i.test(n[0].tagName);
            return {
                top: i.top + this.offset.relative.top * s + this.offset.parent.top * s - (t.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : n.scrollTop()) * s),
                left: i.left + this.offset.relative.left * s + this.offset.parent.left * s - (t.browser.safari && "fixed" == this.cssPosition ? 0 : ("fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : n.scrollLeft()) * s)
            }
        },
        _generatePosition: function(e) {
            var i = this.options
            ...
            var a = e.pageX
              , r = e.pageY;
            if (this.originalPosition && (this.containment && (e.pageX - this.offset.click.left < this.containment[0] && (a = this.containment[0] + this.offset.click.left),
            ...
            i.grid)) {
                ...
                r = this.containment && (o - this.offset.click.top < this.containment[1] || o - this.offset.click.top > this.containment[3]) ? o - this.offset.click.top < this.containment[1] ? o + i.grid[1] : o - i.grid[1] : o;
        ...
        _clear: function(e, i) {
            ...
            !t.ui.contains(this.element[0], this.currentItem[0])) {
                ...
                for (var n = this.containers.length - 1; n >= 0; n--)
                    t.ui.contains(this.containers[n].element[0], this.currentItem[0]) && !i && (s.push((function(t) {
                        return function(e) {
            ...
            for (var n = this.containers.length - 1; n >= 0; n--)
                ...
                this.containers[n].containerCache.over = 0);
            if (this._storedCursor && t("body").css("cursor", this._storedCursor),
            ...
            if (i || this._trigger("beforeStop", e, this._uiHash()),
...
jQuery.effects || function(t, e) {
    ...
    function s(e, s) {
        var n;
        do {
            if ("" != (n = (t.curCSS || t.css)(e, s)) && "transparent" != n || t.nodeName(e, "body"))
                break;
            s = "backgroundColor"
    ...
    function n() {
        var t, e, i = document.defaultView ? document.defaultView.getComputedStyle(this, null) : this.currentStyle, s = {};
        if (i && i.length && i[0] && i[i[0]])
            for (var n = i.length; n--; )
                "string" == typeof i[t = i[n]] && (s[e = t.replace(/\-(\w)/g, function(t, e) {
                    return e.toUpperCase()
                })] = i[t]);
        else
            for (t in i)
                "string" == typeof i[t] && (s[t] = i[t]);
        return s
    }
    function a(e) {
        var i, s;
        for (i in e)
            (null == (s = e[i]) || t.isFunction(s) || i in d || /scrollbar/.test(i) || !/color/i.test(i) && isNaN(parseFloat(s))) && delete e[i];
        return e
    }
    function r(t, e) {
        var i, s = {
    ...
    function o(e, i, s, n) {
        ...
        i = i || {},
        s = s || i.duration,
        s = t.fx.off ? 0 : "number" == typeof s ? s : s in t.fx.speeds ? t.fx.speeds[s] : t.fx.speeds._default,
        n = n || i.complete,
        [e, i, s, n]
    }
    function l(e) {
    ...
    t.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "borderColor", "color", "outlineColor"], function(e, n) {
        t.fx.step[n] = function(t) {
            ...
            t.end = i(t.end),
            t.colorInit = !0),
            t.elem.style[n] = "rgb(" + Math.max(Math.min(parseInt(t.pos * (t.end[0] - t.start[0]) + t.start[0], 10), 255), 0) + "," + Math.max(Math.min(parseInt(t.pos * (t.end[1] - t.start[1]) + t.start[1], 10), 255), 0) + "," + Math.max(Math.min(parseInt(t.pos * (t.end[2] - t.start[2]) + t.start[2], 10), 255), 0) + ")"
        }
    });
    var h = {
        aqua: [0, 255, 255],
    ...
    t.effects.animateClass = function(e, i, s, o) {
        return t.isFunction(s) && (o = s,
        s = null),
        this.queue(function() {
            var l, h = t(this), d = h.attr("style") || " ", u = a(n.call(this)), f = h.attr("class") || "";
            ...
            h.animate(r(u, l), {
                ...
                complete: function() {
                    ...
                    "object" == typeof h.attr("style") ? (h.attr("style").cssText = "",
                    h.attr("style").cssText = d) : h.attr("style", d),
    ...
    t.fn.extend({
        ...
        toggleClass: function(i, s, n, a, r) {
            return "boolean" == typeof s || s === e ? n ? t.effects.animateClass.apply(this, [s ? {
                add: i
            } : {
                remove: i
            }, n, a, r]) : this._toggleClass(i, s) : t.effects.animateClass.apply(this, [{
                toggle: i
            }, s, n, a])
        },
    ...
    t.extend(t.effects, {
        ...
        removeWrapper: function(e) {
            ...
            return e.parent().is(".ui-effects-wrapper") ? (i = e.parent().replaceWith(e),
    ...
    t.fn.extend({
        ...
        show: function(t) {
            ...
            return e[1].mode = "show",
            this.effect.apply(this, e)
        },
        _hide: t.fn.hide,
        hide: function(t) {
            if (l(t))
        ...
        toggle: function(e) {
            ...
            return i[1].mode = "toggle",
            this.effect.apply(this, i)
        },
        cssUnit: function(e) {
            var i = this.css(e)
              , s = [];
    ...
    t.extend(t.easing, {
        ...
        easeInElastic: function(t, e, i, s, n) {
            ...
            o < Math.abs(s)) {
                ...
                var a = r / (2 * Math.PI) * Math.asin(s / o);
            return -(o * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - a) * 2 * Math.PI / r)) + i
        },
        easeOutElastic: function(t, e, i, s, n) {
            ...
            o < Math.abs(s)) {
                ...
                var a = r / (2 * Math.PI) * Math.asin(s / o);
            return o * Math.pow(2, -10 * e) * Math.sin((e * n - a) * 2 * Math.PI / r) + s + i
        },
        easeInOutElastic: function(t, e, i, s, n) {
            ...
            o < Math.abs(s)) {
                ...
                var a = r / (2 * Math.PI) * Math.asin(s / o);
            return e < 1 ? -.5 * o * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * n - a) * 2 * Math.PI / r) + i : o * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * n - a) * 2 * Math.PI / r) * .5 + s + i
        },
        easeInBack: function(t, i, s, n, a, r) {
            return r == e && (r = 1.70158),
            n * (i /= a) * i * ((r + 1) * i - r) + s
        },
        easeOutBack: function(t, i, s, n, a, r) {
            return r == e && (r = 1.70158),
            n * ((i = i / a - 1) * i * ((r + 1) * i + r) + 1) + s
        },
        easeInOutBack: function(t, i, s, n, a, r) {
            return r == e && (r = 1.70158),
            (i /= a / 2) < 1 ? n / 2 * i * i * (((r *= 1.525) + 1) * i - r) + s : n / 2 * ((i -= 2) * i * (((r *= 1.525) + 1) * i + r) + 2) + s
        },
        ...
        easeInOutBounce: function(e, i, s, n, a) {
            return i < a / 2 ? .5 * t.easing.easeInBounce(e, 2 * i, 0, n, a) + s : .5 * t.easing.easeOutBounce(e, 2 * i - a, 0, n, a) + .5 * n + s
        }
    })
}(jQuery),
function(t, e) {
    t.effects.blind = function(e) {
        return this.queue(function() {
            ...
            var r = t.effects.createWrapper(i).css({
              ...
              , o = "vertical" == a ? "height" : "width"
              , l = "vertical" == a ? r.height() : r.width();
            "show" == n && r.css(o, 0);
            var h = {};
            h[o] = "show" == n ? l : 0,
            r.animate(h, e.duration, e.options.easing, function() {
                "hide" == n && i.hide(),
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
    ...
    t.effects.bounce = function(e) {
        return this.queue(function() {
            ...
            var h = "up" == a || "down" == a ? "top" : "left"
              , c = "up" == a || "left" == a ? "pos" : "neg"
              , r = e.options.distance || ("top" == h ? i.outerHeight(!0) / 3 : i.outerWidth(!0) / 3);
            if ("show" == n && i.css("opacity", 0).css(h, "pos" == c ? -r : r),
            "hide" == n && (r /= 2 * o),
            "hide" != n && o--,
            "show" == n) {
                var d = {
                ...
                d[h] = ("pos" == c ? "+=" : "-=") + r,
                i.animate(d, l / 2, e.options.easing),
                r /= 2,
                o--
            }
            for (var u = 0; u < o; u++) {
                ...
                f[h] = ("pos" == c ? "-=" : "+=") + r,
                p[h] = ("pos" == c ? "+=" : "-=") + r,
                i.animate(f, l / 2, e.options.easing).animate(p, l / 2, e.options.easing),
                r = "hide" == n ? 2 * r : r / 2
            }
            if ("hide" == n) {
                var d = {
                ...
                d[h] = ("pos" == c ? "-=" : "+=") + r,
                i.animate(d, l / 2, e.options.easing, function() {
                    i.hide(),
                    t.effects.restore(i, s),
                    t.effects.removeWrapper(i),
                ...
                f[h] = ("pos" == c ? "-=" : "+=") + r,
                p[h] = ("pos" == c ? "+=" : "-=") + r,
                i.animate(f, l / 2, e.options.easing).animate(p, l / 2, e.options.easing, function() {
                    t.effects.restore(i, s),
                    t.effects.removeWrapper(i),
                    e.callback && e.callback.apply(this, arguments)
                })
...
function(t, e) {
    t.effects.drop = function(e) {
        return this.queue(function() {
            ...
            i.show(),
            t.effects.createWrapper(i);
            var r = "up" == a || "down" == a ? "top" : "left"
              , o = "up" == a || "left" == a ? "pos" : "neg"
              , l = e.options.distance || ("top" == r ? i.outerHeight(!0) / 2 : i.outerWidth(!0) / 2);
            "show" == n && i.css("opacity", 0).css(r, "pos" == o ? -l : l);
            var h = {
                opacity: "show" == n ? 1 : 0
            };
            h[r] = ("show" == n ? "pos" == o ? "+=" : "-=" : "pos" == o ? "-=" : "+=") + l,
            i.animate(h, {
                queue: !1,
                duration: e.duration,
                easing: e.options.easing,
    ...
    t.effects.explode = function(e) {
        return this.queue(function() {
            ...
            var n = t(this).show().css("visibility", "hidden")
              , a = n.offset();
            a.top -= parseInt(n.css("marginTop"), 10) || 0,
            a.left -= parseInt(n.css("marginLeft"), 10) || 0;
            for (var r = n.outerWidth(!0), o = n.outerHeight(!0), l = 0; l < i; l++)
                for (var h = 0; h < s; h++)
                    n.clone().appendTo("body").wrap("<div></div>").css({
                        ...
                        width: r / s,
                        height: o / i,
                        left: a.left + h * (r / s) + ("show" == e.options.mode ? (h - Math.floor(s / 2)) * (r / s) : 0),
                        top: a.top + l * (o / i) + ("show" == e.options.mode ? (l - Math.floor(i / 2)) * (o / i) : 0),
                        opacity: "show" == e.options.mode ? 0 : 1
                    }).animate({
                        left: a.left + h * (r / s) + ("show" == e.options.mode ? 0 : (h - Math.floor(s / 2)) * (r / s)),
                        top: a.top + l * (o / i) + ("show" == e.options.mode ? 0 : (l - Math.floor(i / 2)) * (o / i)),
            ...
            setTimeout(function() {
                ...
                e.callback && e.callback.apply(n[0]),
                n.dequeue(),
                t("div.ui-effects-explode").remove()
            }, e.duration || 500)
        })
    }
}(jQuery),
    ...
    t.effects.fold = function(e) {
        return this.queue(function() {
            ...
            var l = t.effects.createWrapper(i).css({
              ...
              , u = /([0-9]+)%/.exec(a);
            u && (a = parseInt(u[1], 10) / 100 * d["hide" == n ? 0 : 1]),
            "show" == n && l.css(r ? {
                height: 0,
                width: a
            } : {
            ...
            f[c[0]] = "show" == n ? d[0] : a,
            p[c[1]] = "show" == n ? d[1] : 0,
            l.animate(f, o, e.options.easing).animate(p, o, e.options.easing, function() {
                "hide" == n && i.hide(),
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
                e.callback && e.callback.apply(i[0], arguments),
        ...
        return this.queue(function() {
            ...
            i.show().css({
                ...
                complete: function() {
                    "hide" == n && i.hide(),
                    t.effects.restore(i, s),
                    "show" != n || t.support.opacity || this.style.removeAttribute("filter"),
                    e.callback && e.callback.apply(this, arguments),
                    i.dequeue()
                }
            })
...
function(t, e) {
    t.effects.puff = function(e) {
        return this.queue(function() {
            ...
            i.effect("scale", e.options, e.duration, e.callback),
            i.dequeue()
        })
    }
    ,
    t.effects.scale = function(e) {
        return this.queue(function() {
            var i = t(this)
              ...
              , o = e.options.origin;
            "effect" != n && (s.origin = o || ["middle", "center"],
            s.restore = !0);
            var l = {
                height: i.height(),
                width: i.width()
            ...
            e.options.fade && ("show" == n && (i.from.opacity = 0,
            i.to.opacity = 1),
            "hide" == n && (i.from.opacity = 1,
            i.to.opacity = 0)),
            s.from = i.from,
            s.to = i.to,
            s.mode = n,
    ...
    t.effects.size = function(e) {
        return this.queue(function() {
            ...
            if (i.from = e.options.from || f,
            i.to = e.options.to || f,
            u) {
                var p = t.effects.getBaseline(u, f);
                i.from.top = (f.height - i.from.height) * p.y,
                i.from.left = (f.width - i.from.width) * p.x,
                i.to.top = (f.height - i.to.height) * p.y,
                i.to.left = (f.width - i.to.width) * p.x
            }
            var m = {
                from: {
                    y: i.from.height / f.height,
                    x: i.from.width / f.width
                },
                to: {
                    y: i.to.height / f.height,
                    x: i.to.width / f.width
                }
            };
            ("box" == d || "both" == d) && (m.from.y != m.to.y && (s = s.concat(o),
            i.from = t.effects.setTransition(i, o, m.from.y, i.from),
            i.to = t.effects.setTransition(i, o, m.to.y, i.to)),
            m.from.x != m.to.x && (s = s.concat(l),
            i.from = t.effects.setTransition(i, l, m.from.x, i.from),
            i.to = t.effects.setTransition(i, l, m.to.x, i.to))),
            ("content" == d || "both" == d) && m.from.y != m.to.y && (s = s.concat(r),
            i.from = t.effects.setTransition(i, r, m.from.y, i.from),
            i.to = t.effects.setTransition(i, r, m.to.y, i.to)),
            t.effects.save(i, c ? s : n),
            i.show(),
            t.effects.createWrapper(i),
            i.css("overflow", "hidden").css(i.from),
            ("content" == d || "both" == d) && (o = o.concat(["marginTop", "marginBottom"]).concat(r),
            l = l.concat(["marginLeft", "marginRight"]),
            a = s.concat(o).concat(l),
            i.find("*[width]").each(function() {
                var i = t(this);
                c && t.effects.save(i, a);
                var s = {
                    height: i.height(),
                    width: i.width()
                };
                i.from = {
                    height: s.height * m.from.y,
                    width: s.width * m.from.x
                },
                i.to = {
                    height: s.height * m.to.y,
                    width: s.width * m.to.x
                },
                m.from.y != m.to.y && (i.from = t.effects.setTransition(i, o, m.from.y, i.from),
                i.to = t.effects.setTransition(i, o, m.to.y, i.to)),
                m.from.x != m.to.x && (i.from = t.effects.setTransition(i, l, m.from.x, i.from),
                i.to = t.effects.setTransition(i, l, m.to.x, i.to)),
                i.css(i.from),
                i.animate(i.to, e.duration, e.options.easing, function() {
                    c && t.effects.restore(i, a)
                })
            })),
            i.animate(i.to, {
                queue: !1,
    ...
    t.effects.shake = function(e) {
        return this.queue(function() {
            var i = t(this)
              , s = ["position", "top", "bottom", "left", "right"]
              , n = (t.effects.setMode(i, e.options.mode || "effect"),
            e.options.direction || "left")
              , a = e.options.distance || 20
              , r = e.options.times || 3
              , o = e.duration || e.options.duration || 140;
            t.effects.save(i, s),
            i.show(),
            t.effects.createWrapper(i);
            ...
            d[l] = ("pos" == h ? "+=" : "-=") + 2 * a,
            u[l] = ("pos" == h ? "-=" : "+=") + 2 * a,
            i.animate(c, o, e.options.easing);
            for (var f = 1; f < r; f++)
                i.animate(d, o, e.options.easing).animate(u, o, e.options.easing);
            i.animate(d, o, e.options.easing).animate(c, o / 2, e.options.easing, function() {
                t.effects.restore(i, s),
                t.effects.removeWrapper(i),
                e.callback && e.callback.apply(this, arguments)
            }),
...
function(t, e) {
    t.effects.slide = function(e) {
        return this.queue(function() {
            ...
            t.effects.save(i, s),
            i.show(),
            t.effects.createWrapper(i).css({
                overflow: "hidden"
            });
            var r = "up" == a || "down" == a ? "top" : "left"
              , o = "up" == a || "left" == a ? "pos" : "neg"
              , l = e.options.distance || ("top" == r ? i.outerHeight(!0) : i.outerWidth(!0));
            "show" == n && i.css(r, "pos" == o ? isNaN(l) ? "-" + l : -l : l);
            var h = {};
            h[r] = ("show" == n ? "pos" == o ? "+=" : "-=" : "pos" == o ? "-=" : "+=") + l,
            i.animate(h, {
                queue: !1,
    ...
    t.effects.transfer = function(e) {
        return this.queue(function() {
            var i = t(this)
              ...
              , r = i.offset()
              , o = t('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(e.options.className).css({
                top: r.top,
                left: r.left,
                height: i.innerHeight(),
                width: i.innerWidth(),
                position: "absolute"
            }).animate(a, e.duration, e.options.easing, function() {
                o.remove(),
                e.callback && e.callback.apply(i[0], arguments),
                i.dequeue()
            })
...
function(t, e) {
    t.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            e.headers = e.element.find(i.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.accordion", function() {
            ...
            e.active = e._findActive(e.active || i.active).addClass("ui-state-default ui-state-active").toggleClass("ui-corner-all").toggleClass("ui-corner-top"),
            e.active.next().addClass("ui-accordion-content-active"),
            e._createIcons(),
            e.resize(),
            e.element.attr("role", "tablist"),
            e.headers.attr("role", "tab").bind("keydown.accordion", function(t) {
                return e._keydown(t)
            ...
            i.event && e.headers.bind(i.event.split(" ").join(".accordion ") + ".accordion", function(t) {
                e._clickHandler.call(e, t, this),
                t.preventDefault()
            })
        },
        _createIcons: function() {
            var e = this.options;
            e.icons && (t("<span></span>").addClass("ui-icon " + e.icons.header).prependTo(this.headers),
        ...
        destroy: function() {
            ...
            return (e.autoHeight || e.fillHeight) && i.css("height", ""),
            t.Widget.prototype.destroy.call(this)
        },
        _setOption: function(e, i) {
            t.Widget.prototype._setOption.apply(this, arguments),
        ...
        _keydown: function(e) {
            if (!this.options.disabled && !e.altKey && !e.ctrlKey) {
                ...
                return !a || (t(e.target).attr("tabIndex", -1),
                t(a).attr("tabIndex", 0),
                a.focus(),
                !1)
            }
        ...
        _clickHandler: function(e, i) {
            ...
            if (!s.disabled) {
                ...
                var o = t(e.currentTarget || i)
                  , l = o[0] === this.active[0];
                if (s.active = (!s.collapsible || !l) && this.headers.index(o),
                !this.running && (s.collapsible || !l)) {
                    var h = this.active
                      , r = o.next()
                      , n = this.active.next()
                      , a = {
                        options: s,
                        newHeader: l && s.collapsible ? t([]) : o,
                        oldHeader: this.active,
                        newContent: l && s.collapsible ? t([]) : r,
                        oldContent: n
                    }
                      , c = this.headers.index(this.active[0]) > this.headers.index(o[0]);
                    this.active = l ? t([]) : o,
                    this._toggle(r, n, a, l, c),
                    h.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(s.icons.headerSelected).addClass(s.icons.header),
                    l || (o.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(s.icons.header).addClass(s.icons.headerSelected),
        ...
        _toggle: function(e, i, s, n, a) {
            ...
            if (r._trigger("changestart", null, r.data),
            r.running = 0 === i.size() ? e.size() : i.size(),
            o.animated) {
                var h = {};
                h = o.collapsible && n ? {
                    toShow: t([]),
                ...
                o.proxied || (o.proxied = o.animated),
                o.proxiedDuration || (o.proxiedDuration = o.duration),
                o.animated = t.isFunction(o.proxied) ? o.proxied(h) : o.proxied,
                o.duration = t.isFunction(o.proxiedDuration) ? o.proxiedDuration(h) : o.proxiedDuration;
                var c = t.ui.accordion.animations
                  , d = o.duration
                  , u = o.animated;
                !u || c[u] || t.easing[u] || (u = "slide"),
                c[u] || (c[u] = function(t) {
                    this.slide(t, {
                        easing: u,
                        duration: d || 700
                ...
                o.collapsible && n ? e.toggle() : (i.hide(),
                e.show()),
                l(!0);
            i.prev().attr({
                "aria-expanded": "false",
    ...
    t.extend(t.ui.accordion, {
        ...
        animations: {
            slide: function(e, i) {
                ...
                var s, n = e.toShow.css("overflow"), a = 0, r = {}, o = {}, l = ["height", "paddingTop", "paddingBottom"], h = e.toShow;
                s = h[0].style.width,
                h.width(h.parent().width() - parseFloat(h.css("paddingLeft")) - parseFloat(h.css("paddingRight")) - (parseFloat(h.css("borderLeftWidth")) || 0) - (parseFloat(h.css("borderRightWidth")) || 0)),
                t.each(l, function(i, s) {
                    o[s] = "hide";
                ...
                e.toHide.filter(":hidden").each(e.complete).end().filter(":visible").animate(o, {
                    step: function(t, i) {
                        "height" == i.prop && (a = i.end - i.start == 0 ? 0 : (i.now - i.start) / (i.end - i.start)),
                        e.toShow[0].style[i.prop] = a * r[i.prop].value + r[i.prop].unit
                    },
                    duration: e.duration,
                    easing: e.easing,
                    complete: function() {
...
function(t, e) {
    ...
    t.widget("ui.autocomplete", {
        ...
        pending: 0,
        _create: function() {
            var e, i = this, s = this.element[0].ownerDocument;
            ...
            this._initSource(),
            this.menu = t("<ul></ul>").addClass("ui-autocomplete").appendTo(t(this.options.appendTo || "body", s)[0]).mousedown(function(e) {
                ...
                selected: function(t, e) {
                    var n = e.item.data("item.autocomplete")
                      , a = i.previous;
                    i.element[0] !== s.activeElement && (i.element.focus(),
                    i.previous = a,
                    setTimeout(function() {
                        i.previous = a,
                        i.selectedItem = n
                    }, 1)),
                    !1 !== i._trigger("select", t, {
                        item: n
        ...
        search: function(t, e) {
            return (t = null != t ? t : this.element.val(),
            this.term = this.element.val(),
            t.length < this.options.minLength) ? this.close(e) : (clearTimeout(this.closing),
        ...
        __response: function(t) {
            !this.options.disabled && t && t.length ? (t = this._normalize(t),
            this._suggest(t),
    ...
    t.widget("ui.menu", {
        _create: function() {
            ...
            this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({
                ...
                t(i.target).closest(".ui-menu-item a").length && (i.preventDefault(),
                e.select(i))
            }),
            this.refresh()
        },
        ...
        previousPage: function(e) {
            if (this.hasScroll()) {
                ...
                n.length || (n = this.element.children(".ui-menu-item:first")),
                this.activate(e, n)
            } else
...
function(t, e) {
    var i, s, n, a, r = "ui-button ui-widget ui-state-default ui-corner-all", o = "ui-state-hover ui-state-active ", l = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", h = function() {
    ...
    t.widget("ui.button", {
        ...
        _create: function() {
            ...
            this.buttonElement.addClass(r).attr("role", "button").bind("mouseenter.button", function() {
                o.disabled || (t(this).addClass("ui-state-hover"),
                this === i && t(this).addClass("ui-state-active"))
            }).bind("mouseleave.button", function() {
                o.disabled || t(this).removeClass(d)
            ...
            this.buttonElement.bind("mousedown.button", function(t) {
                ...
                o.disabled || s === t.pageX && n === t.pageY || (a = !0)
            })),
        ...
        _determineButtonType: function() {
            if (this.element.is(":checkbox") ? this.type = "checkbox" : this.element.is(":radio") ? this.type = "radio" : this.element.is("input") ? this.type = "input" : this.type = "button",
        ...
        destroy: function() {
            ...
            this.buttonElement.removeClass(r + " " + o + " " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()),
            this.hasTitle || this.buttonElement.removeAttr("title"),
            t.Widget.prototype.destroy.call(this)
        },
        _setOption: function(e, i) {
            if (t.Widget.prototype._setOption.apply(this, arguments),
            "disabled" === e) {
        ...
        _resetButton: function() {
            ...
            this.hasTitle || e.attr("title", i))) : a.push("ui-button-text-only"),
            e.addClass(a.join(" "))
        }
    }),
    t.widget("ui.buttonset", {
        ...
        _setOption: function(e, i) {
            "disabled" === e && this.buttons.button("option", e, i),
            t.Widget.prototype._setOption.apply(this, arguments)
        },
        refresh: function() {
...
function($, undefined) {
    ...
    function bindHover(t) {
        ...
        return t.bind("mouseout", function(t) {
            ...
            !$.datepicker._isDisabledDatepicker(instActive.inline ? t.parent()[0] : instActive.input[0]) && s.length && (s.parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    function extendRemove(t, e) {
        ...
        e)
            (null == e[i] || undefined == e[i]) && (t[i] = e[i]);
        return t
    }
    function isArray(t) {
    ...
    var instActive, PROP_NAME = "datepicker", dpuuid = (new Date).getTime();
    $.extend(Datepicker.prototype, {
        ...
        _connectDatepicker: function(t, e) {
            ...
            i.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(this._doKeyPress).keyup(this._doKeyUp).bind("setData.datepicker", function(t, i, s) {
                e.settings[i] = s
        ...
        _attachments: function(t, e) {
            ...
            i && (e.append = $('<span class="' + this._appendClass + '">' + i + "</span>"),
            t[s ? "before" : "after"](e.append)),
            t.unbind("focus", this._showDatepicker),
            e.trigger && e.trigger.remove();
            var n = this._get(e, "showOn");
            if (("focus" == n || "both" == n) && t.focus(this._showDatepicker),
            "button" == n || "both" == n) {
        ...
        _destroyDatepicker: function(t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                ...
                "input" == s ? (i.append.remove(),
                i.trigger.remove(),
                e.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp)) : ("div" == s || "span" == s) && e.removeClass(this.markerClassName).empty()
            }
        },
        _enableDatepicker: function(t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                ...
                if ("input" == s)
                    ...
                    n.find("select.ui-datepicker-month, select.ui-datepicker-year").removeAttr("disabled")
                }
        ...
        _disableDatepicker: function(t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                ...
                if ("input" == s)
                    ...
                    n.find("select.ui-datepicker-month, select.ui-datepicker-year").attr("disabled", "disabled")
                }
                this._disabledInputs = $.map(this._disabledInputs, function(e) {
                    return e == t ? null : e
                }),
        ...
        _optionDatepicker: function(t, e, i) {
            ...
            if (2 == arguments.length && "string" == typeof e)
                return "defaults" == e ? $.extend({}, $.datepicker._defaults) : s ? "all" == e ? $.extend({}, s.settings) : this._get(s, e) : null;
            var n = e || {};
            ...
            s) {
                ...
                null !== r && undefined !== n.dateFormat && undefined === n.minDate && (s.settings.minDate = this._formatDate(s, r)),
                null !== o && undefined !== n.dateFormat && undefined === n.maxDate && (s.settings.maxDate = this._formatDate(s, o)),
            ...
            $.datepicker._datepickerShowing)
                ...
                case 13:
                    ...
                    if (a) {
                        ...
                        a.apply(e.input ? e.input[0] : null, [r, e])
                    } else
                        $.datepicker._hideDatepicker();
                    return !1;
                case 27:
                ...
                36 == t.keyCode && t.ctrlKey ? $.datepicker._showDatepicker(this) : i = !1;
            i && (t.preventDefault(),
            t.stopPropagation())
        },
        ...
        _showDatepicker: function(t) {
            ...
            !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                ...
                if (!1 !== s) {
                    ...
                    n && $.browser.opera && ($.datepicker._pos[0] -= document.documentElement.scrollLeft,
                    ...
                    $.datepicker._updateDatepicker(e),
                    a = $.datepicker._checkOffset(e, a, n),
                    e.dpDiv.css({
                    ...
                    !e.inline) {
                        ...
                        $.effects && $.effects[r] ? e.dpDiv.show(r, $.datepicker._get(e, "showOptions"), o, l) : e.dpDiv[r || "show"](r ? o : null, l),
                        r && o || l(),
        ...
        _checkOffset: function(t, e, i) {
            ...
            e.left -= Math.min(e.left, e.left + s > o && o > s ? Math.abs(e.left + s - o) : 0),
            e.top -= Math.min(e.top, e.top + n > l && l > n ? Math.abs(n + r) : 0),
            e
        },
        _findPos: function(t) {
            for (var e = this._getInst(t), i = this._get(e, "isRTL"); t && ("hidden" == t.type || 1 != t.nodeType || $.expr.filters.hidden(t)); )
        ...
        _hideDatepicker: function(t) {
            ...
            if (e && (!t || e == $.data(t, PROP_NAME)) && this._datepickerShowing) {
                ...
                a && a.apply(e.input ? e.input[0] : null, [e.input ? e.input.val() : "", e]),
        ...
        parseDate: function(t, e, i) {
            ...
            for (var n = (i ? i.dayNamesShort : null) || this._defaults.dayNamesShort, a = (i ? i.dayNames : null) || this._defaults.dayNames, r = (i ? i.monthNamesShort : null) || this._defaults.monthNamesShort, o = (i ? i.monthNames : null) || this._defaults.monthNames, l = -1, h = -1, c = -1, d = -1, u = !1, f = function(e) {
                ...
                var n = $.map(f(t) ? s : i, function(t, e) {
                    return [[e, t]]
                }).sort(function(t, e) {
                ...
                if ($.each(n, function(t, i) {
                    var s = i[1];
                    if (e.substr(v, s.length).toLowerCase() == s.toLowerCase())
                        return a = i[0],
                        v += s.length,
                        !1
                }),
            ...
            if (v < e.length)
                throw "Extra/unparsed characters found in date: " + e.substring(v);
            if (-1 == l ? l = (new Date).getFullYear() : l < 100 && (l += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (l <= s ? 0 : -100)),
            d > -1)
                for (h = 1,
                c = d; ; ) {
            ...
            if (y.getFullYear() != l || y.getMonth() + 1 != h || y.getDate() != c)
                throw "Invalid date";
            return y
        },
        ATOM: "yy-mm-dd",
                ...
                for (var u = 0; u < t.length; u++)
                    if (d)
                        ...
                        case "M":
                            ...
                            break;
                        case "y":
                            c += o("y") ? e.getFullYear() : (e.getYear() % 100 < 10 ? "0" : "") + e.getYear() % 100;
                            break;
                        case "@":
                            c += e.getTime();
                            break;
        ...
        _setDateFromField: function(t, e) {
            if (t.input.val() != t.lastVal) {
                var i, s, n = this._get(t, "dateFormat"), a = t.lastVal = t.input ? t.input.val() : null;
                ...
                t.currentDay = a ? i.getDate() : 0,
                t.currentMonth = a ? i.getMonth() : 0,
                t.currentYear = a ? i.getFullYear() : 0,
        ...
        _determineDate: function(t, e, i) {
            var s = function(t) {
              ...
              , n = function(e) {
                ...
                for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), a = s.getMonth(), r = s.getDate(), o = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, l = o.exec(e); l; ) {
                    switch (l[2] || "d") {
                    case "d":
                    case "D":
                        r += parseInt(l[1], 10);
            ...
            return (a = a && "Invalid Date" == a.toString() ? i : a) && (a.setHours(0),
            a.setMinutes(0),
            a.setSeconds(0),
            a.setMilliseconds(0)),
        ...
        _generateHTML: function(t) {
            ...
            p--),
            u) {
                var m = this._daylightSavingAdjust(new Date(u.getFullYear(),u.getMonth() - r[0] * r[1] + 1,u.getDate()));
                for (m = d && m < d ? d : m; this._daylightSavingAdjust(new Date(p,f,1)) > m; )
                    --f < 0 && (f = 11,
                    p--)
            }
            t.drawMonth = f,
            ...
            g = a ? this.formatDate(g, this._daylightSavingAdjust(new Date(p,f - l,1)), this._getFormatConfig(t)) : g;
            var v = this._canAdjustMonth(t, -1, p, f) ? '<a class="ui-datepicker-prev ui-corner-all" data-handler="prev" data-event="click" title="' + g + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + g + "</span></a>" : n ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + g + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "e" : "w") + '">' + g + "</span></a>"
              , b = this._get(t, "nextText");
            b = a ? this.formatDate(b, this._daylightSavingAdjust(new Date(p,f + l,1)), this._getFormatConfig(t)) : b;
            var y = this._canAdjustMonth(t, 1, p, f) ? '<a class="ui-datepicker-next ui-corner-all" data-handler="next" data-event="click" title="' + b + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + b + "</span></a>" : n ? "" : '<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' + b + '"><span class="ui-icon ui-icon-circle-triangle-' + (i ? "w" : "e") + '">' + b + "</span></a>"
              , w = this._get(t, "currentText")
              , _ = this._get(t, "gotoCurrent") && t.currentDay ? c : e;
            w = a ? this.formatDate(w, _, this._getFormatConfig(t)) : w;
            var k = t.inline ? "" : '<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>"
              , D = s ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (i ? k : "") + (this._isInRange(t, _) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + w + "</button>" : "") + (i ? "" : k) + "</div>" : ""
              , C = parseInt(this._get(t, "firstDay"), 10);
            C = isNaN(C) ? 0 : C;
            for (var x = this._get(t, "showWeek"), S = this._get(t, "dayNames"), P = (this._get(t, "dayNamesShort"),
            this._get(t, "dayNamesMin")), T = this._get(t, "monthNames"), M = this._get(t, "monthNamesShort"), A = this._get(t, "beforeShowDay"), E = this._get(t, "showOtherMonths"), I = this._get(t, "selectOtherMonths"), O = (this._get(t, "calculateWeek") || this.iso8601Week,
            this._getDefaultDate(t)), F = "", Y = 0; Y < r[0]; Y++) {
                var L = "";
                this.maxRows = 4;
                for (var z = 0; z < r[1]; z++) {
                    var H = this._daylightSavingAdjust(new Date(p,f,t.selectedDay))
                      , W = " ui-corner-all"
                      , N = "";
                    if (h) {
                    ...
                    N += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + W + '">' + (/all|left/.test(W) && 0 == Y ? i ? y : v : "") + (/all|right/.test(W) && 0 == Y ? i ? v : y : "") + this._generateMonthYearHeader(t, f, p, d, u, Y > 0 || z > 0, T, M) + '</div><table class="ui-datepicker-calendar"><thead><tr>';
                    for (var R = x ? '<th class="ui-datepicker-week-col">' + this._get(t, "weekHeader") + "</th>" : "", j = 0; j < 7; j++) {
                        var B = (j + C) % 7;
                        R += "<th" + ((j + C + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + '><span title="' + S[B] + '">' + P[B] + "</span></th>"
                    }
                    N += R + "</tr></thead><tbody>";
                    var q = this._getDaysInMonth(p, f);
                    p == t.selectedYear && f == t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, q));
                    var V = (this._getFirstDayOfMonth(p, f) - C + 7) % 7
                      , U = Math.ceil((V + q) / 7)
                      , K = h && this.maxRows > U ? this.maxRows : U;
                    this.maxRows = K;
                    for (var G = this._daylightSavingAdjust(new Date(p,f,1 - V)), X = 0; X < K; X++) {
                        N += "<tr>";
                        for (var Z = x ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(G) + "</td>" : "", j = 0; j < 7; j++) {
                            var Q = A ? A.apply(t.input ? t.input[0] : null, [G]) : [!0, ""]
                              , J = G.getMonth() != f
                              , tt = J && !I || !Q[0] || d && G < d || u && G > u;
                            Z += '<td class="' + ((j + C + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (J ? " ui-datepicker-other-month" : "") + (G.getTime() == H.getTime() && f == t.selectedMonth && t._keyEvent || O.getTime() == G.getTime() && O.getTime() == H.getTime() ? " " + this._dayOverClass : "") + (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") + (J && !E ? "" : " " + Q[1] + (G.getTime() == c.getTime() ? " " + this._currentClass : "") + (G.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + ((!J || E) && Q[2] ? ' title="' + Q[2] + '"' : "") + (tt ? "" : ' data-handler="selectDay" data-event="click" data-month="' + G.getMonth() + '" data-year="' + G.getFullYear() + '"') + ">" + (J && !E ? "&#xa0;" : tt ? '<span class="ui-state-default">' + G.getDate() + "</span>" : '<a class="ui-state-default' + (G.getTime() == e.getTime() ? " ui-state-highlight" : "") + (G.getTime() == c.getTime() ? " ui-state-active" : "") + (J ? " ui-priority-secondary" : "") + '" href="#">' + G.getDate() + "</a>") + "</td>",
                    ...
                    ++f > 11 && (f = 0,
                    p++),
                    N += "</tbody></table>" + (h ? "</div>" + (r[0] > 0 && z == r[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""),
                    L += N
                }
                F += L
            }
            return F += D + ($.browser.msie && 7 > parseInt($.browser.version, 10) && !t.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""),
            t._keyEvent = !1,
            F
        },
        _generateMonthYearHeader: function(t, e, i, s, n, a, r, o) {
            var l = this._get(t, "changeMonth")
              ...
              , u = "";
            if (a || !l)
                u += '<span class="ui-datepicker-month">' + r[e] + "</span>";
            else {
                var f = s && s.getFullYear() == i
                  , p = n && n.getFullYear() == i;
                u += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">';
                for (var m = 0; m < 12; m++)
                    (!f || m >= s.getMonth()) && (!p || m <= n.getMonth()) && (u += '<option value="' + m + '"' + (m == e ? ' selected="selected"' : "") + ">" + o[m] + "</option>");
                u += "</select>"
            }
            if (c || (d += u + (!a && l && h ? "" : "&#xa0;")),
            !t.yearshtml) {
                ...
                a || !h)
                    ...
                    var g = this._get(t, "yearRange").split(":")
                      ...
                      , b = $(g[0])
                      , y = Math.max(b, $(g[1] || ""));
                    for (b = s ? Math.max(b, s.getFullYear()) : b,
                    y = n ? Math.min(y, n.getFullYear()) : y,
                    t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; b <= y; b++)
            ...
            return d += this._get(t, "yearSuffix"),
            c && (d += (!a && l && h ? "" : "&#xa0;") + u),
            d += "</div>"
        },
    ...
    t.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            var e = this
              , s = e.options
              , n = s.title || "&#160;"
              , a = t.ui.dialog.getTitleId(e.element)
              , r = (e.uiDialog = t("<div></div>")).appendTo(document.body).hide().addClass(i + s.dialogClass).css({
                zIndex: s.zIndex
            }).attr("tabIndex", -1).css("outline", 0).keydown(function(i) {
                s.closeOnEscape && !i.isDefaultPrevented() && i.keyCode && i.keyCode === t.ui.keyCode.ESCAPE && (e.close(i),
                i.preventDefault())
            }).attr({
                role: "dialog",
                "aria-labelledby": a
              ...
              , o = (e.element.show().removeAttr("title").addClass("ui-dialog-content ui-widget-content").appendTo(r),
            (e.uiDialogTitlebar = t("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(r))
            ...
            (e.uiDialogTitlebarCloseText = t("<span></span>")).addClass("ui-icon ui-icon-closethick").text(s.closeText).appendTo(l),
            t("<span></span>").addClass("ui-dialog-title").attr("id", a).html(n).prependTo(o),
        ...
        destroy: function() {
            var t = this;
            return t.overlay && t.overlay.destroy(),
            t.uiDialog.hide(),
        ...
        close: function(e) {
            ...
            if (!1 !== n._trigger("beforeClose", e))
                ...
                n._isOpen = !1,
                n.options.hide ? n.uiDialog.hide(n.options.hide, function() {
                    n._trigger("close", e)
                }) : (n.uiDialog.hide(),
                n._trigger("close", e)),
                ...
                t(".ui-dialog").each(function() {
                    this !== n.uiDialog[0] && (s = t(this).css("z-index"),
        ...
        moveToTop: function(e, i) {
            var s, n = this, a = n.options;
            return (!a.modal || e) && (a.stack || a.modal) ? (a.zIndex > t.ui.dialog.maxZ && (t.ui.dialog.maxZ = a.zIndex),
            n.overlay && (t.ui.dialog.maxZ += 1,
            n.overlay.$el.css("z-index", t.ui.dialog.overlay.maxZ = t.ui.dialog.maxZ)),
            s = {
        ...
        open: function() {
            if (!this._isOpen) {
                var e = this
                  , i = e.options
                  , s = e.uiDialog;
                return e.overlay = i.modal ? new t.ui.dialog.overlay(e) : null,
                e._size(),
                e._position(i.position),
                s.show(i.show),
                e.moveToTop(!0),
                i.modal && s.bind("keydown.ui-dialog", function(e) {
                    if (e.keyCode === t.ui.keyCode.TAB) {
                        var i = t(":tabbable", this)
                          , s = i.filter(":first")
                          , n = i.filter(":last");
                        if (e.target === n[0] && !e.shiftKey)
                            return s.focus(1),
                            !1;
                        if (e.target === s[0] && e.shiftKey)
                            return n.focus(1),
                            !1
                    }
                }),
                t(e.element.find(":tabbable").get().concat(s.find(".ui-dialog-buttonpane :tabbable").get().concat(s.get()))).eq(0).focus(),
                e._isOpen = !0,
                e._trigger("open"),
                e
            }
        ...
        _createButtons: function(e) {
            ...
            s && (t.each(e, function(e, s) {
                ...
                t.each(s, function(t, e) {
                    "click" !== t && (t in a ? n[t](e) : n.attr(t, e))
                }),
        ...
        _makeDraggable: function() {
            ...
            var i, s = this, n = s.options, a = t(document);
            s.uiDialog.draggable({
                cancel: ".ui-dialog-content, .ui-dialog-titlebar-close",
                handle: ".ui-dialog-titlebar",
                containment: "document",
                start: function(a, r) {
                    i = "auto" === n.height ? "auto" : t(this).height(),
                    t(this).height(t(this).height()).addClass("ui-dialog-dragging"),
                    s._trigger("dragStart", a, e(r))
                },
                drag: function(t, i) {
                    s._trigger("drag", t, e(i))
                },
                stop: function(r, o) {
                    n.position = [o.position.left - a.scrollLeft(), o.position.top - a.scrollTop()],
                    t(this).removeClass("ui-dialog-dragging").height(i),
                    s._trigger("dragStop", r, e(o)),
                    t.ui.dialog.overlay.resize()
                }
            })
        },
        ...
        _position: function(e) {
            var i, s = [], n = [0, 0];
            e ? (("string" == typeof e || "object" == typeof e && "0"in e) && (1 === (s = e.split ? e.split(" ") : [e[0], e[1]]).length && (s[1] = s[0]),
        ...
        _setOption: function(e, s) {
            ...
            case "closeText":
                ...
                break;
            case "dialogClass":
                a.removeClass(n.options.dialogClass).addClass(i + s);
                break;
            case "disabled":
                s ? a.addClass("ui-dialog-disabled") : a.removeClass("ui-dialog-disabled");
                break;
            case "draggable":
                var r = a.is(":data(draggable)");
                r && !s && a.draggable("destroy"),
                !r && s && n._makeDraggable();
                break;
            case "position":
                n._position(s);
                break;
            case "resizable":
                var o = a.is(":data(resizable)");
                o && !s && a.resizable("destroy"),
                o && "string" == typeof s && a.resizable("option", "handles", s),
                o || !1 === s || n._makeResizable(s);
                break;
            case "title":
        ...
        _size: function() {
            var e, i, s = this.options, n = this.uiDialog.is(":visible");
            ...
            "auto" === s.height) {
                if (t.support.minHeight)
                    ...
                    this.element.height(Math.max(a, i))
                }
            } else
                this.element.height(Math.max(s.height - e, 0));
        ...
        create: function(e) {
            0 === this.instances.length && (setTimeout(function() {
                t.ui.dialog.overlay.instances.length && t(document).bind(t.ui.dialog.overlay.events, function(e) {
                    if (t(e.target).zIndex() < t.ui.dialog.overlay.maxZ)
                        return !1
                })
            }, 1),
            t(document).bind("keydown.dialog-overlay", function(i) {
                e.options.closeOnEscape && !i.isDefaultPrevented() && i.keyCode && i.keyCode === t.ui.keyCode.ESCAPE && (e.close(i),
                i.preventDefault())
            }),
            ...
            return t.fn.bgiframe && i.bgiframe(),
...
function(t, e) {
    ...
    t.fn.position = function(e) {
        ...
        e = t.extend({}, e);
        var o, l, h, c = t(e.of), d = c[0], u = (e.collision || "flip").split(" "), f = e.offset ? e.offset.split(" ") : [0, 0];
        return 9 === d.nodeType ? (o = c.width(),
        l = c.height(),
        h = {
            top: 0,
            left: 0
        }) : d.setTimeout ? (o = c.width(),
        l = c.height(),
        h = {
            top: c.scrollTop(),
            left: c.scrollLeft()
        }) : d.preventDefault ? (e.at = "left top",
        o = l = 0,
        h = {
            top: e.of.pageY,
            left: e.of.pageX
        ...
        t.each(["my", "at"], function() {
            var t = (e[this] || "").split(" ");
            1 === t.length && (t = i.test(t[0]) ? t.concat([n]) : s.test(t[0]) ? [n].concat(t) : [n, n]),
            t[0] = i.test(t[0]) ? t[0] : n,
            t[1] = s.test(t[1]) ? t[1] : n,
            e[this] = t
        }),
        1 === u.length && (u[1] = u[0]),
        ...
        "right" === e.at[0] ? h.left += o : e.at[0] === n && (h.left += o / 2),
        "bottom" === e.at[1] ? h.top += l : e.at[1] === n && (h.top += l / 2),
        h.left += f[0],
        h.top += f[1],
        this.each(function() {
            var i, s = t(this), r = s.outerWidth(), c = s.outerHeight(), d = parseInt(t.curCSS(this, "marginLeft", !0)) || 0, p = parseInt(t.curCSS(this, "marginTop", !0)) || 0, m = r + d + (parseInt(t.curCSS(this, "marginRight", !0)) || 0), g = c + p + (parseInt(t.curCSS(this, "marginBottom", !0)) || 0), v = t.extend({}, h);
            "right" === e.my[0] ? v.left -= r : e.my[0] === n && (v.left -= r / 2),
            "bottom" === e.my[1] ? v.top -= c : e.my[1] === n && (v.top -= c / 2),
            a.fractions || (v.left = Math.round(v.left),
    ...
    t.ui.position = {
        ...
        flip: {
            left: function(e, i) {
                if (i.at[0] !== n) {
                    var s = t(window)
                      , a = i.collisionPosition.left + i.collisionWidth - s.width() - s.scrollLeft()
                      , r = "left" === i.my[0] ? -i.elemWidth : "right" === i.my[0] ? i.elemWidth : 0
                      , o = "left" === i.at[0] ? i.targetWidth : -i.targetWidth
                      , l = -2 * i.offset[0];
                    e.left += i.collisionPosition.left < 0 ? r + o + l : a > 0 ? r + o + l : 0
                }
            },
            top: function(e, i) {
                if (i.at[1] !== n) {
                    var s = t(window)
                      , a = i.collisionPosition.top + i.collisionHeight - s.height() - s.scrollTop()
                      , r = "top" === i.my[1] ? -i.elemHeight : "bottom" === i.my[1] ? i.elemHeight : 0
                      , o = "top" === i.at[1] ? i.targetHeight : -i.targetHeight
                      , l = -2 * i.offset[1];
                    e.top += i.collisionPosition.top < 0 ? r + o + l : a > 0 ? r + o + l : 0
                }
            }
        }
    },
    t.offset.setOffset || (t.offset.setOffset = function(e, i) {
        ...
        "using"in i ? i.using.call(e, o) : s.css(o)
    }
    ,
    ...
    function() {
        var e, i, s, n, r, o = document.getElementsByTagName("body")[0], l = document.createElement("div");
        for (var h in e = document.createElement(o ? "div" : "body"),
        s = {
            visibility: "hidden",
            width: 0,
            height: 0,
        ...
        n = t(l).offset(function(t, e) {
            return e
        }).offset(),
        e.innerHTML = "",
        i.removeChild(e),
        r = n.top + n.left + (o ? 2e3 : 0),
        a.fractions = r > 21 && r < 22
    }()
}(jQuery),
function(t, e) {
    t.widget("ui.progressbar", {
        ...
        value: function(t) {
            return void 0 === t ? this._value() : (this._setOption("value", t),
            this)
        },
        _setOption: function(e, i) {
            "value" === e && (this.options.value = i,
            this._refreshValue(),
...
function(t, e) {
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _create: function() {
            ...
            this._mouseInit(),
            this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget ui-widget-content ui-corner-all" + (s.disabled ? " ui-slider-disabled ui-disabled" : "")),
            this.range = t([]),
            s.range && (!0 === s.range && (s.values || (s.values = [this._valueMin(), this._valueMin()]),
            s.values.length && 2 !== s.values.length && (s.values = [s.values[0], s.values[0]])),
            this.range = t("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header" + ("min" === s.range || "max" === s.range ? " ui-slider-range-" + s.range : "")));
            for (var l = n.length; l < r; l += 1)
                o.push(a);
            this.handles = n.add(t(o.join("")).appendTo(e.element)),
            ...
            this.handles.add(this.range).filter("a").click(function(t) {
                ...
                s.disabled ? t(this).blur() : (t(".ui-slider .ui-state-focus").removeClass("ui-state-focus"),
            ...
            this.handles.keydown(function(s) {
                var n, a, r, o, l = t(this).data("index.ui-slider-handle");
                if (!e.options.disabled) {
                    ...
                    case t.ui.keyCode.LEFT:
                        if (s.preventDefault(),
                        !e._keySliding && (e._keySliding = !0,
                        t(this).addClass("ui-state-active"),
                        !1 === (n = e._start(s, l))))
                            return
                    }
                    switch (o = e.options.step,
                    a = r = e.options.values && e.options.values.length ? e.values(l) : e.value(),
                    s.keyCode) {
                    case t.ui.keyCode.HOME:
                        r = e._valueMin();
                        break;
                    case t.ui.keyCode.END:
                        ...
                        break;
                    case t.ui.keyCode.PAGE_UP:
                        r = e._trimAlignValue(a + (e._valueMax() - e._valueMin()) / i);
                        break;
                    case t.ui.keyCode.PAGE_DOWN:
                        r = e._trimAlignValue(a - (e._valueMax() - e._valueMin()) / i);
                        break;
        ...
        _mouseCapture: function(e) {
            var i, s, n, a, r, o, l, h, c, d = this.options;
            ...
            !0 === d.range && this.values(1) === d.min && (o += 1,
            a = t(this.handles[o])),
            !1 !== (l = this._start(e, o)) && (this._mouseSliding = !0,
            r._handleIndex = o,
            a.addClass("ui-state-active").focus(),
            h = a.offset(),
            c = !t(e.target).parents().andSelf().is(".ui-slider-handle"),
            this._clickOffset = c ? {
                left: 0,
                top: 0
            } : {
        ...
        _setOption: function(e, i) {
            var s, n = 0;
            switch (t.isArray(this.options.values) && (n = this.options.values.length),
            t.Widget.prototype._setOption.apply(this, arguments),
            e) {
            case "disabled":
        ...
        _values: function(t) {
            ...
            for (s = 0,
            i = this.options.values.slice(); s < i.length; s += 1)
        ...
        _refreshValue: function() {
            var e, i, s, n, a, r = this.options.range, o = this.options, l = this, h = !this._animateOff && o.animate, c = {};
            this.options.values && this.options.values.length ? this.handles.each(function(s, n) {
                ...
                t(this).stop(1, 1)[h ? "animate" : "css"](c, o.animate),
            ...
            n = this._valueMin(),
            e = (a = this._valueMax()) !== n ? (s - n) / (a - n) * 100 : 0,
            c["horizontal" === l.orientation ? "left" : "bottom"] = e + "%",
...
function(t, e) {
    ...
    t.widget("ui.tabs", {
        ...
        _setOption: function(t, e) {
            "selected" == t ? this.options.collapsible && e == this.options.selected || this.select(e) : (this.options[t] = e,
            this._tabify())
        },
        _tabId: function(t) {
        ...
        _tabify: function(i) {
            function s(e, i) {
                e.css("display", ""),
                !t.support.opacity && i.opacity && e[0].style.removeAttribute("filter")
            }
            var n, a, r = this, o = this.options, l = /^#.+/;
            ...
            this.anchors.each(function(e, i) {
                var s, n = t(i).attr("href"), a = n.split("#")[0];
                if (a && (a === location.toString().split("#")[0] || (s = t("base")[0]) && a === s.href) && (n = i.hash,
                i.href = n),
                l.test(n))
                    r.panels = r.panels.add(r.element.find(r._sanitizeSelector(n)));
                else if (n && "#" !== n) {
                    t.data(i, "href.tabs", n),
                    t.data(i, "load.tabs", n.replace(/#.*$/, ""));
                    var h = r._tabId(i);
                    i.href = "#" + h;
                    var c = r.element.find("#" + h);
                    c.length || (c = t(o.panelTemplate).attr("id", h).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(r.panels[e - 1] || r.list)).data("destroy.tabs", !0),
                    r.panels = r.panels.add(c)
                } else
                    o.disabled.push(e)
            }),
            ...
            o.selected === e ? (location.hash && this.anchors.each(function(t, e) {
                if (e.hash == location.hash)
                    return o.selected = t,
                    !1
            }),
            "number" != typeof o.selected && o.cookie && (o.selected = parseInt(r._cookie(), 10)),
            ...
            o.disabled = t.unique(o.disabled.concat(t.map(this.lis.filter(".ui-state-disabled"), function(t, e) {
                return r.lis.index(t)
            }))).sort(),
            -1 != t.inArray(o.selected, o.disabled) && o.disabled.splice(t.inArray(o.selected, o.disabled), 1),
            this.panels.addClass("ui-tabs-hide"),
            this.lis.removeClass("ui-tabs-selected ui-state-active"),
            o.selected >= 0 && this.anchors.length && (r.element.find(r._sanitizeSelector(r.anchors[o.selected].hash)).removeClass("ui-tabs-hide"),
            this.lis.eq(o.selected).addClass("ui-tabs-selected ui-state-active"),
            r.element.queue("tabs", function() {
                r._trigger("show", null, r._ui(r.anchors[o.selected], r.element.find(r._sanitizeSelector(r.anchors[o.selected].hash))[0]))
            }),
            ...
            for (var h, c = 0; h = this.lis[c]; c++)
                t(h)[-1 == t.inArray(c, o.disabled) || t(h).hasClass("ui-tabs-selected") ? "removeClass" : "addClass"]("ui-state-disabled");
            if (!1 === o.cache && this.anchors.removeData("cache.tabs"),
            ...
            o.fx && (t.isArray(o.fx) ? (n = o.fx[0],
            a = o.fx[1]) : n = a = o.fx);
            var f = a ? function(e, i) {
                t(e).closest("li").addClass("ui-tabs-selected ui-state-active"),
                i.hide().removeClass("ui-tabs-hide").animate(a, a.duration || "normal", function() {
                    s(i, a),
                    r._trigger("show", null, r._ui(e, i[0]))
                })
            }
            : function(e, i) {
                t(e).closest("li").addClass("ui-tabs-selected ui-state-active"),
            ...
            this.anchors.bind(o.event + ".tabs", function() {
                ...
                if (i.hasClass("ui-tabs-selected") && !o.collapsible || i.hasClass("ui-state-disabled") || i.hasClass("ui-state-processing") || r.panels.filter(":animated").length || !1 === r._trigger("select", null, r._ui(this, n[0])))
                    return this.blur(),
                    !1;
                if (o.selected = r.anchors.index(this),
                r.abort(),
                o.collapsible) {
                    if (i.hasClass("ui-tabs-selected"))
                        return o.selected = -1,
                        o.cookie && r._cookie(o.selected, o.cookie),
                        r.element.queue("tabs", function() {
                            p(e, s)
                        }).dequeue("tabs"),
                        this.blur(),
                        !1;
                    if (!s.length)
                        return o.cookie && r._cookie(o.selected, o.cookie),
                        r.element.queue("tabs", function() {
                            f(e, n)
                        }),
                ...
                if (o.cookie && r._cookie(o.selected, o.cookie),
                n.length)
        ...
        add: function(i, s, n) {
            ...
            var a = this
              , r = this.options
              , o = t(r.tabTemplate.replace(/#\{href\}/g, i).replace(/#\{label\}/g, s))
              , l = i.indexOf("#") ? this._tabId(t("a", o)[0]) : i.replace("#", "");
            o.addClass("ui-state-default ui-corner-top").data("destroy.tabs", !0);
            var h = a.element.find("#" + l);
            return h.length || (h = t(r.panelTemplate).attr("id", l).data("destroy.tabs", !0)),
            h.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide"),
            n >= this.lis.length ? (o.appendTo(this.list),
            h.appendTo(this.list[0].parentNode)) : (o.insertBefore(this.lis[n]),
            h.insertBefore(this.panels[n])),
            r.disabled = t.map(r.disabled, function(t, e) {
                return t >= n ? ++t : t
            }),
            this._tabify(),
            1 == this.anchors.length && (r.selected = 0,
        ...
        remove: function(e) {
            ...
            return s.hasClass("ui-tabs-selected") && this.anchors.length > 1 && this.select(e + (e + 1 < this.anchors.length ? 1 : -1)),
            i.disabled = t.map(t.grep(i.disabled, function(t, i) {
                return t != e
            }), function(t, i) {
                return t >= e ? --t : t
            }),
        ...
        enable: function(e) {
            ...
            if (-1 != t.inArray(e, i.disabled))
                return this.lis.eq(e).removeClass("ui-state-disabled"),
        ...
        disable: function(t) {
            t = this._getIndex(t);
            var e = this.options;
            return t != e.selected && (this.lis.eq(t).addClass("ui-state-disabled"),
            e.disabled.push(t),
            e.disabled.sort(),
            this._trigger("disable", null, this._ui(this.anchors[t], this.panels[t]))),
            this
        },
        select: function(t) {
            ...
            return this.anchors.eq(t).trigger(this.options.event + ".tabs"),
            this
        },
        load: function(e) {
            e = this._getIndex(e);
            var i = this
              ...
              , a = t.data(n, "load.tabs");
            if (this.abort(),
            !a || 0 !== this.element.queue("tabs").length && t.data(n, "cache.tabs")) {
                this.element.dequeue("tabs");
                return
            }
            if (this.lis.eq(e).addClass("ui-state-processing"),
            s.spinner) {
                var r = t("span", n);
            ...
            return this.xhr = t.ajax(t.extend({}, s.ajaxOptions, {
                ...
                success: function(a, r) {
                    i.element.find(i._sanitizeSelector(n.hash)).html(a),
                    i._cleanup(),
                    s.cache && t.data(n, "cache.tabs", !0),
                    i._trigger("load", null, i._ui(i.anchors[e], i.panels[e]));
                    try {
                        s.ajaxOptions.success(a, r)
                    } catch (o) {}
                },
        ...
        url: function(t, e) {
            return this.anchors.eq(t).removeData("cache.tabs").data("load.tabs", e),
            this
        },
        length: function() {
    ...
    t.extend(t.ui.tabs.prototype, {
        ...
        rotate: function(t, e) {
            var i = this
              ...
              , a = i._unrotate || (i._unrotate = e ? function(t) {
                n()
            }
            : function(t) {
            ...
            return t ? (this.element.bind("tabsshow", n),
            this.anchors.bind(s.event + ".tabs", a),
            n()) : (clearTimeout(i.rotation),
...
function(t, e) {
    ...
    t.widget("kf." + c, {
        ...
        _create: function() {
            var e, a, h = this, u = h.options, f = h.element, p = f.find(u.steps).eq(0).parent();
            f[0].elements ? e = f : (e = f.find(l)).length || (e = f.closest(l)),
            (a = f.find(u.header)).length || (a = e.find(u.header)),
            h.elements = {
                form: e.addClass(n.form),
                submit: e.find(u.submit),
                forward: e.find(u.forward),
                backward: e.find(u.backward),
                header: a.addClass(n.header),
                steps: f.find(u.steps).hide().addClass(n.step),
                branches: f.find(u.branches).add(p).addClass(n.branch),
                stepsWrapper: p.addClass(n.wrapper),
                wizard: f.addClass(c)
            },
            p.attr(o) || p.attr(o, c + "-" + ++i),
            ...
            h.elements.steps.each(function(e) {
                h._branchLabels[e] = t(this).parent().attr(o)
            }),
            h._excludesFilter = function() {
                return !t(this).hasClass(u.stepClasses.exclude)
            }
            ,
            u.transitions[d] || (u.transitions[d] = function(t) {
                return h.stepIndex(t.nextAll(s.step))
            }
            ),
            h.select.apply(h, r(u.initialStep))
        },
        _fastForward: function(i, s, n) {
            var a = 0
              , r = this
              , o = r._currentState.stepIndex
              , l = [o];
            t.isFunction(s) && (n = s,
            s = e),
            function e() {
                r._transition(o, function(h, c) {
                    if (-1 === (o = r.stepIndex(h, c)))
                        throw Error('[_fastForward]: Invalid step "' + h + '"');
                    if (t.inArray(o, l) >= 0)
                        throw Error('[_fastForward]: Recursion detected on step "' + h + '"');
                    l.push(o),
                    o === r._lastStepIndex || (s ? ++a : o) === i ? n.call(r, o, l) : e()
                })
            }()
        },
        _find: function(e, i, s) {
            var n, a, o, l, h, c = [], d = i instanceof jQuery ? i : t(i);
            function m(t, e) {
                if (e === l)
                    return n = e,
                    !1
            ...
            if (null !== e && d.length)
                for (a = 0,
                o = (e = r(e)).length; a < o; a++)
                    n = null,
                    (h = typeof (l = e[a])) === u ? n = d.get(l) : h === p ? n = document.getElementById(l.replace("#", "")) : h === f && (l instanceof jQuery && l.length && (l = l[0]),
                    l.nodeType && d.each(m)),
                    n && c.push(n);
            return !1 === s ? c : t(c)
        },
        _move: function(i, s, n, a, r) {
            var o = this
              , l = o._currentState;
            function h(i, s) {
                r.call(o, i, t.isArray(a) ? a : !1 !== a ? s : e)
            }
            typeof s === m && (r = a,
            a = n,
            n = s,
            s = e),
            !0 === n ? i > 0 ? o._fastForward(i, n, h) : r.call(o, l.stepsActivated[Math.max(0, i + (l.stepsActivated.length - 1))]) : -1 !== (i = o.stepIndex(i, s)) && (i > l.stepIndex ? o._fastForward(i, h) : h.call(o, i))
        },
        _state: function(e, i) {
            if (!this.isValidStepIndex(e))
                return null;
            this.options;
            ...
            for (var a, o, l, h = 0, c = i.length; h < c; h++)
                e = i[h],
                a = this._branchLabels[e],
                !n.stepIndex || n.stepIndex < e ? 0 > t.inArray(e, n.stepsActivated) && (n.stepsActivated.push(e),
                0 > t.inArray(a, n.branchesActivated) && n.branchesActivated.push(a)) : n.stepIndex > e && (o = t.inArray(a, n.branchesActivated) + 1,
                l = t.inArray(e, n.stepsActivated) + 1,
                o > 0 && n.branchesActivated.splice(o, n.branchesActivated.length - 1),
                l > 0 && n.stepsActivated.splice(l, n.stepsActivated.length - 1)),
                n.stepIndex = e,
                n.branchLabel = a;
            return n.stepsComplete = Math.max(0, this._find(n.stepsActivated, this.elements.steps).filter(this._excludesFilter).length - 1),
        ...
        _transition: function(i, s, n) {
            var o = this;
            t.isFunction(i) ? (n = i,
            i = o._currentState.stepIndex,
            s = e) : t.isFunction(s) && (n = s,
            s = e);
            var l, h = o.options, c = o.step(i, s), u = c.attr(h.stateAttribute), f = u ? h.transitions[u] : h.transitions[d];
            return e !== (l = t.isFunction(f) ? f.call(o, c, function() {
                return n.apply(o, a.call(arguments))
            }) : u) && !1 !== l && n.apply(o, r(l)),
            l
        },
        _update: function(e, i) {
            var s = this._currentState
              , n = this.options;
            if (s.step) {
                if (n.disabled || !i || i.stepIndex === s.stepIndex || !this._trigger(k, e, i) || i.isMovingForward && !this._trigger(_, e, i) || !i.isMovingForward && !this._trigger(y, e, i))
                    return;
            ...
            s.step && (this._trigger(b, e, i),
            this._trigger(i.isMovingForward ? $ : g, e, i))
        },
        backward: function(t, i) {
            typeof t === u && (i = t,
            t = e),
            i === e && (i = 1),
            !this._currentState.isFirstStep && typeof i === u && this._move(-i, !0, !1, function(e, i) {
        ...
        destroy: function() {
            var e = this.elements;
            this._trigger(w, null, this.state()) && (this.element.removeClass(c),
        ...
        forward: function(t, i, s) {
            ...
            t = e),
            i === e && (i = 1),
            !this._currentState.isLastStep && typeof i === u && this._move(i, !0, s, function(e, i) {
                this._update(t, this._state(e, i))
            })
        },
        ...
        isValidStepIndex: function(t) {
            return typeof t === u && t >= 0 && t <= this._lastStepIndex
        },
        stepCount: function() {
            return this._stepCount
        },
        select: function(i, s, n, a, r) {
            i instanceof t.Event || (r = a,
            a = n,
            n = s,
            s = i,
            i = e),
            ...
            a = n,
            n = s[1],
            s = s[0]) : typeof n === m ? (r = a,
            a = n,
            n = e) : t.isArray(n) && (r = n,
            n = e),
            this._move(s, n, a, r, function(t, e) {
                this._update(i, this._state(t, e))
            }))
        },
        state: function(i, s, n) {
            return arguments.length ? (t.isArray(i) ? (n = s,
            s = i[1],
            i = i[0]) : t.isArray(s) && (n = s,
            s = e),
            this._state(this.stepIndex(i, s), n)) : this._currentState
        },
        step: function(i, s) {
            var a;
            return arguments.length ? (t.isArray(i) && (s = i[1],
            i = i[0]),
            typeof i === u ? a = this._find(i, s !== e ? this.steps(s) : this.elements.steps) : (a = this._find(i, this.elements.steps.add(this.elements.branches))) && a.hasClass(n.branch) && (a = this._find(s || 0, this.steps(a))),
            a) : this._currentState.step
        },
        stepIndex: function(i, n, a) {
            var r;
            return arguments.length ? (t.isArray(i) ? (a = n,
            n = i[1],
            i = i[0]) : typeof n === m && (a = n,
            n = e),
            (r = this.step(i, n)) ? (a ? r.siblings(s.step).andSelf() : this.elements.steps).index(r) : -1) : this._currentState.stepIndex
        },
        steps: function(t) {
    ...
    t.extend(t.validator, {
        ...
        prototype: {
            init: function() {
                ...
                t(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'] ,[type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", s).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", s),
            ...
            check: function(e) {
                ...
                for (var r in s) {
                    ...
                    try {
                        if (i = t.validator.methods[r].call(this, a, e, o.parameters),
                        ...
                        throw this.settings.debug && window.console && console.log("Exception occurred when checking element " + e.id + ", check the '" + o.method + "' method.", l),
                        l
                    }
                }
                if (!n)
        ...
        attributeRules: function(e) {
            var i, s = {}, n = t(e), a = n[0].getAttribute("type");
            for (var r in t.validator.methods)
                "required" === r ? ("" === (i = n.get(0).getAttribute(r)) && (i = !0),
                i = !!i) : i = n.attr(r),
                /min|max/.test(r) && (null === a || /number|range|text/.test(a)) && (i = Number(i)),
                i ? s[r] = i : a === r && "range" !== a && (s[r] = !0);
        ...
        dataRules: function(e) {
            ...
            for (i in t.validator.methods)
                void 0 !== (s = a.data("rule-" + i.toLowerCase())) && (n[i] = s);
            return n
        },
                ...
                t.ajax(t.extend(!0, {
                    ...
                    success: function(s) {
                        ...
                        if (r) {
                            ...
                            var l = {}
                              , h = s || a.defaultMessage(i, "remote");
                            l[i.name] = n.message = t.isFunction(h) ? h(e) : h,
                            a.invalid[i.name] = !0,
                            a.showErrors(l)
                        }
                        n.valid = r,
...
function(t) {
    ...
    if (t.ajaxPrefilter)
        ...
        t.ajax = function(s) {
            ...
            return "abort" === n ? (e[a] && e[a].abort(),
            e[a] = i.apply(this, arguments),
            e[a]) : i.apply(this, arguments)
        }
    }
}(jQuery),
...
function(t) {
    t.fn.niceSelect = function(e) {
        ...
        t(document).on("keydown.nice_select", ".nice-select", function(e) {
            ...
            if (38 == e.keyCode) {
                if (i.hasClass("open")) {
                    var a = s.prevAll(".option:not(.disabled)").first();
                    a.length > 0 && (i.find(".focus").removeClass("focus"),
                    a.addClass("focus"))
                } else
                    i.trigger("click");
                return !1
        ...
        return s.cssText = "pointer-events:auto",
        "auto" !== s.pointerEvents && t("html").addClass("no-csspointerevents"),
        this
    }
}(jQuery),
function(t) {
    ...
    o.prototype = {
        ...
        isType: function(t, i) {
            return (i = i || this.options.states)[t = t || this.state(e, e, i).props.type] && (t = i[t].props.type),
            this.element.prop("type") === t
        },
        state: function(t, i, s) {
            return s = s || this.options.states,
        ...
        wrapElement: function(e) {
            var i, s = e.enforceWidth;
            return this.wrapperElement.length || (i = this.element.outerWidth(),
            t.each(e.inheritStyles, t.proxy(function(t, i) {
        ...
        updateToggle: function(t, e) {
            var i, s;
            return this.toggleElement.length && (i = "padding-" + this.options.toggle.position,
            ...
            s = this.toggleElement.outerWidth() + 2 * this.options.toggle.offset,
        ...
        toggleTouchEvent: function(t) {
            ...
            n && (e = t.pageX || t.originalEvent.pageX,
            "left" === this.options.toggle.position ? (n += this.toggleElement.outerWidth(),
            i = e,
            s = n) : (i = n,
            s = e),
...
function(t) {
    ...
    function d(t, e) {
        ...
        if (s) {
            for (var o = 0; o < s; o++)
                n[o] = i[o].style.cssText,
                i[o].style.setProperty ? i[o].style.setProperty("display", "block", "important") : i[o].style.cssText += ";display: block !important",
                i[o].style.height = "0",
                i[o].style.overflow = "hidden",
                i[o].style.visibility = "hidden",
                r(i[o]);
            a = t[e];
            for (var l = 0; l < s; l++)
                i[l].style.cssText = n[l],
                r(i[l])
        }
        return a
    }
    ...
    function p(e, h) {
        ...
        this.init();
        var c = this;
        this.$window.on("resize." + this.identifier, l(function() {
            o(function() {
                c.update(!1, !1)
            }, 300)
        }, 20)),
        ...
        this.$element.on("change." + this.identifier, function(t, e) {
            if (!e || e.origin !== c.identifier) {
                var i = t.target.value
                  , s = c.getPositionFromValue(i);
                c.setPosition(s)
            }
        })
    }
    ...
    p.prototype.update = function(t, e) {
        (t = t || !1) && (this.min = u(this.$element[0].getAttribute("min"), 0),
        this.max = u(this.$element[0].getAttribute("max"), 100),
        this.value = u(this.$element[0].value, Math.round(this.min + (this.max - this.min) / 2)),
        this.step = u(this.$element[0].getAttribute("step"), 1)),
        this.handleDimension = d(this.$handle[0], "offset" + f(this.DIMENSION)),
        this.rangeDimension = d(this.$range[0], "offset" + f(this.DIMENSION)),
    ...
    ,
    p.prototype.cap = function(t, e, i) {
    ...
    p.prototype.getRelativePosition = function(t) {
        var e = f(this.COORDINATE)
          , i = this.$range[0].getBoundingClientRect()[this.DIRECTION]
          , s = 0;
        return void 0 !== t.originalEvent["client" + e] ? s = t.originalEvent["client" + e] : t.originalEvent.touches && t.originalEvent.touches[0] && void 0 !== t.originalEvent.touches[0]["client" + e] ? s = t.originalEvent.touches[0]["client" + e] : t.currentPoint && void 0 !== t.currentPoint[this.COORDINATE] && (s = t.currentPoint[this.COORDINATE]),
        s - i
    }
    ,
    p.prototype.getPositionFromValue = function(t) {
        var e, i;
        return Number.isNaN(e = (t - this.min) / (this.max - this.min)) ? 0 : e * this.maxHandlePos
    }
    ,
    p.prototype.getValueFromPosition = function(t) {
        var e, i;
        return e = t / (this.maxHandlePos || 1),
        Number((i = this.step * Math.round(e * (this.max - this.min) / this.step) + this.min).toFixed(this.toFixed))
    }
    ,
    ...
    t.fn[i] = function(e) {
        ...
        return this.each(function() {
            var n = t(this)
              , a = n.data("plugin_" + i);
            a || n.data("plugin_" + i, a = new p(this,e)),
            "string" == typeof e && a[e].apply(a, s)
        })
    }
    ,
...
function(t, e) {
    ...
    function d(t) {
        if (null == t._isValid) {
            var e = c(t)
              , i = D.call(e.parsedDateParts, function(t) {
                return null != t
            })
              , s = !isNaN(t._d.getTime()) && e.overflow < 0 && !e.empty && !e.invalidMonth && !e.invalidWeekday && !e.weekdayMismatch && !e.nullInput && !e.invalidFormat && !e.userInvalidated && (!e.meridiem || e.meridiem && i);
    ...
    ;
    var f = t.momentProperties = [];
    function p(t, e) {
        var i, n, a;
        if (s(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject),
        s(e._i) || (t._i = e._i),
        s(e._f) || (t._f = e._f),
        s(e._l) || (t._l = e._l),
    ...
    function b(t) {
        var e = +t
          , i = 0;
        return 0 !== e && isFinite(e) && (i = $(e)),
        i
    }
    function y(t, e, i) {
        var s, n = Math.min(t.length, e.length), a = Math.abs(t.length - e.length), r = 0;
        for (s = 0; s < n; s++)
            (i && t[s] !== e[s] || !i && b(t[s]) !== b(e[s])) && r++;
        return r + a
    }
    function w(e) {
    ...
    function T(t, e) {
        var s, n = l({}, t);
        for (s in e)
            o(e, s) && (i(t[s]) && i(e[s]) ? (n[s] = {},
            l(n[s], t[s]),
            l(n[s], e[s])) : null != e[s] ? n[s] = e[s] : delete n[s]);
        for (s in t)
            o(t, s) && !o(e, s) && i(t[s]) && (n[s] = l({}, n[s]));
        return n
    }
    function M(t) {
        null != t && this.set(t)
    ...
    function L(t, e, i) {
        var s = "" + Math.abs(t);
        return (0 <= t ? i ? "+" : "" : "-") + Math.pow(10, Math.max(0, e - s.length)).toString().substr(1) + s
    }
    ...
    function R(t, e, i, s) {
        ...
        t && (N[t] = n),
        e && (N[e[0]] = function() {
            return L(n.apply(this, arguments), e[1], e[2])
        }
        ),
        i && (N[i] = function() {
    ...
    function j(t, e) {
        return t.isValid() ? (W[e = B(e, t.localeData())] = W[e] || function(t) {
            var e, i, s, n = t.match(z);
            for (e = 0,
            i = n.length; e < i; e++)
                N[n[e]] ? n[e] = N[n[e]] : n[e] = (s = n[e]).match(/\[[\s\S]/) ? s.replace(/^\[|\]$/g, "") : s.replace(/\\/g, "");
            return function(e) {
                var s, a = "";
                for (s = 0; s < i; s++)
                    a += P(n[s]) ? n[s].call(e, t) : n[s];
                return a
            }
        }(e),
    ...
    var q = /\d/
      ...
      , tn = /Z|[+-]\d\d:?\d\d/gi
      , ta = /Z|[+-]\d\d(?::?\d\d)?/gi
      , tr = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i
      , to = {};
    function tl(t, e, i) {
        to[t] = P(e) ? e : function(t, s) {
            return t && i ? i : e
        }
    }
    function th(t, e) {
        return o(to, t) ? to[t](e._strict, e._locale) : RegExp(tc(t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(t, e, i, s, n) {
            return e || i || s || n
        })))
    }
    function tc(t) {
    ...
    tu("YYYY", function(e, i) {
        i[tp] = 2 === e.length ? t.parseTwoDigitYear(e) : b(e)
    }),
    tu("YY", function(e, i) {
        i[tp] = t.parseTwoDigitYear(e)
    }),
    tu("Y", function(t, e) {
        e[tp] = parseInt(t, 10)
    }),
    ...
    ;
    var tD, tC = tx("FullYear", !0);
    function tx(e, i) {
        return function(s) {
            return null != s ? (tP(this, e, s),
    ...
    function tP(t, e, i) {
        t.isValid() && !isNaN(i) && ("FullYear" === e && tk(t.year()) && 1 === t.month() && 29 === t.date() ? t._d["set" + (t._isUTC ? "UTC" : "") + e](i, t.month(), tT(i, t.month())) : t._d["set" + (t._isUTC ? "UTC" : "") + e](i))
    }
    function tT(t, e) {
        if (isNaN(t) || isNaN(e))
            return NaN;
        var i, s = (e % (i = 12) + i) % i;
        return t += (e - s) / 12,
        1 === s ? tk(t) ? 29 : 28 : 31 - s % 7 % 2
    }
    tD = Array.prototype.indexOf ? Array.prototype.indexOf : function(t) {
        var e;
    ...
    tu(["MMM", "MMMM"], function(t, e, i, s) {
        ...
        null != n ? e[tm] = n : c(i).invalidMonth = t
    });
    var tM = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/
    ...
    function tI(t, e) {
        ...
        return i = Math.min(t.date(), tT(t.year(), e)),
        t._d["set" + (t._isUTC ? "UTC" : "") + "Month"](e, i),
        t
    }
    function tO(e) {
        return null != e ? (tI(this, e),
    ...
    function tz(t, e, i) {
        var s = 7 + e - i;
        return -((7 + tL(t, 0, s).getUTCDay() - e) % 7) + s - 1
    }
    function tH(t, e, i, s, n) {
        var a, r, o = 1 + 7 * (e - 1) + (7 + i - s) % 7 + tz(t, s, n);
        return r = o <= 0 ? t_(a = t - 1) + o : o > t_(t) ? (a = t + 1,
        o - t_(t)) : (a = t,
        o),
        {
            year: a,
    ...
    function tW(t, e, i) {
        var s, n, a = tz(t.year(), e, i), r = Math.floor((t.dayOfYear() - a - 1) / 7) + 1;
        return r < 1 ? s = r + tN(n = t.year() - 1, e, i) : r > tN(t.year(), e, i) ? (s = r - tN(t.year(), e, i),
        n = t.year() + 1) : (n = t.year(),
        s = r),
        {
            week: s,
    ...
    tf(["dd", "ddd", "dddd"], function(t, e, i, s) {
        var n = i._locale.weekdaysParse(t, s, i._strict);
        null != n ? e.d = n : c(i).invalidWeekday = t
    }),
    tf(["d", "e", "E"], function(t, e, i, s) {
        e[s] = b(t)
    });
    var t9 = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_")
      , t3 = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_")
      , tj = "Su_Mo_Tu_We_Th_Fr_Sa".split("_")
      , tB = tr
      , tq = tr
      , t1 = tr;
    function tV() {
    ...
    R("hmm", 0, 0, function() {
        return "" + t2.apply(this) + L(this.minutes(), 2)
    }),
    R("hmmss", 0, 0, function() {
        return "" + t2.apply(this) + L(this.minutes(), 2) + L(this.seconds(), 2)
    }),
    R("Hmm", 0, 0, function() {
    ...
    function tZ(t) {
        var e = null;
        if (!tK[t] && "undefined" != typeof module && module && module.exports)
            try {
                e = t5._abbr,
                require("./locale/" + t),
                tQ(e)
    ...
    function tQ(t, e) {
        var i;
        return t && ((i = s(e) ? et(t) : tJ(t, e)) ? t5 = i : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")),
        t5._abbr
    }
    function tJ(t, e) {
        if (null === e)
        ...
        null != tK[t])
            ...
            if (null != tK[e.parentLocale])
                s = tK[e.parentLocale]._config;
            else {
                if (null == (i = tZ(e.parentLocale)))
                    return tG[e.parentLocale] || (tG[e.parentLocale] = []),
                    tG[e.parentLocale].push({
                        name: t,
                        config: e
                    }),
                    null;
        ...
        return tK[t] = new M(T(s, e)),
        tG[t] && tG[t].forEach(function(t) {
            tJ(t.name, t.config)
        }),
        tQ(t),
        tK[t]
    ...
    function et(t) {
        ...
        return function(t) {
            for (var e, i, s, n, a = 0; a < t.length; ) {
                for (e = (n = tX(t[a]).split("-")).length,
                i = (i = tX(t[a + 1])) ? i.split("-") : null; 0 < e; ) {
                    if (s = tZ(n.slice(0, e).join("-")))
                        return s;
                    if (i && i.length >= e && y(n, i, !0) >= e - 1)
                        break;
                    e--
                }
                a++
    ...
    function ee(t) {
        var e, i = t._a;
        return i && -2 === c(t).overflow && (e = i[tm] < 0 || 11 < i[tm] ? tm : i[tg] < 1 || i[tg] > tT(i[tp], i[tm]) ? tg : i[tv] < 0 || 24 < i[tv] || 24 === i[tv] && (0 !== i[t8] || 0 !== i[t$] || 0 !== i[tb]) ? tv : i[t8] < 0 || 59 < i[t8] ? t8 : i[t$] < 0 || 59 < i[t$] ? t$ : i[tb] < 0 || 999 < i[tb] ? tb : -1,
        c(t)._overflowDayOfYear && (e < tp || tg < e) && (e = tg),
        c(t)._overflowWeeks && -1 === e && (e = ty),
        c(t)._overflowWeekday && -1 === e && (e = tw),
        c(t).overflow = e),
        t
    }
    function ei(t, e, i) {
    ...
    function es(e) {
        ...
        if (!e._d) {
            for (i = e,
            s = new Date(t.now()),
            r = i._useUTC ? [s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate()] : [s.getFullYear(), s.getMonth(), s.getDate()],
            e._w && null == e._a[tg] && null == e._a[tm] && function(t) {
                var e, i, s, n, a, r, o, l;
                if (null != (e = t._w).GG || null != e.W || null != e.E)
                    a = 1,
                    r = 4,
                    i = ei(e.GG, t._a[tp], tW(e8(), 1, 4).year),
                    s = ei(e.W, 1),
                    ((n = ei(e.E, 1)) < 1 || 7 < n) && (l = !0);
                else {
                    a = t._locale._week.dow,
                    r = t._locale._week.doy;
                    var h = tW(e8(), a, r);
                    i = ei(e.gg, t._a[tp], h.year),
                    s = ei(e.w, h.week),
                    null != e.d ? ((n = e.d) < 0 || 6 < n) && (l = !0) : null != e.e ? (n = e.e + a,
                    (e.e < 0 || 6 < e.e) && (l = !0)) : n = a
                }
                s < 1 || s > tN(i, a, r) ? c(t)._overflowWeeks = !0 : null != l ? c(t)._overflowWeekday = !0 : (o = tH(i, s, n, a, r),
                t._a[tp] = o.year,
                t._dayOfYear = o.dayOfYear)
            }(e),
            null != e._dayOfYear && (l = ei(e._a[tp], r[tp]),
            (e._dayOfYear > t_(l) || 0 === e._dayOfYear) && (c(e)._overflowDayOfYear = !0),
            a = tL(l, 0, e._dayOfYear),
            e._a[tm] = a.getUTCMonth(),
            e._a[tg] = a.getUTCDate()),
            n = 0; n < 3 && null == e._a[n]; ++n)
                e._a[n] = h[n] = r[n];
            for (; n < 7; n++)
                e._a[n] = h[n] = null == e._a[n] ? 2 === n ? 1 : 0 : e._a[n];
            24 === e._a[tv] && 0 === e._a[t8] && 0 === e._a[t$] && 0 === e._a[tb] && (e._nextDay = !0,
            e._a[tv] = 0),
            e._d = (e._useUTC ? tL : function(t, e, i, s, n, a, r) {
                var o;
                return t < 100 && 0 <= t ? (o = new Date(t + 400,e,i,s,n,a,r),
                isFinite(o.getFullYear()) && o.setFullYear(t)) : o = new Date(t,e,i,s,n,a,r),
                o
            }
            ).apply(null, h),
            o = e._useUTC ? e._d.getUTCDay() : e._d.getDay(),
            null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm),
            e._nextDay && (e._a[tv] = 24),
            e._w && void 0 !== e._w.d && e._w.d !== o && (c(e).weekdayMismatch = !0)
        }
    }
    var en = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/
      ...
      , el = [["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/], ["HH:mm:ss", /\d\d:\d\d:\d\d/], ["HH:mm", /\d\d:\d\d/], ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/], ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/], ["HHmmss", /\d\d\d\d\d\d/], ["HHmm", /\d\d\d\d/], ["HH", /\d\d/]]
      , eh = /^\/?Date\((\-?\d+)/i;
    function ec(t) {
        var e, i, s, n, a, r, o = t._i, l = en.exec(o) || ea.exec(o);
        if (l) {
            for (c(t).iso = !0,
            e = 0,
            i = eo.length; e < i; e++)
    ...
    var ed = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
    function eu(t, e, i, s, n, a) {
        var r, o, l = [(r = t,
        (o = parseInt(r, 10)) <= 49 ? 2e3 + o : o <= 999 ? 1900 + o : o), tE.indexOf(e), parseInt(i, 10), parseInt(s, 10), parseInt(n, 10)];
        return a && l.push(parseInt(a, 10)),
        l
    }
    var ef = {
        UT: 0,
    ...
    function ep(t) {
        var e, i, s, n = ed.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
        if (n) {
            var a = eu(n[4], n[3], n[2], n[5], n[6], n[7]);
            if (e = n[1],
            i = a,
            s = t,
            e && t3.indexOf(e) !== new Date(i[0],i[1],i[2]).getDay() && (c(s).weekdayMismatch = !0,
            s._isValid = !1,
            1))
                return;
            t._a = a,
    ...
    function em(e) {
        if (e._f !== t.ISO_8601) {
            if (e._f !== t.RFC_2822) {
                e._a = [],
                c(e).empty = !0;
                var i, s, n, a, r, l, h, d, u, f, p, m, g = "" + e._i, v = g.length, $ = 0;
                for (h = B(e._f, e._locale).match(z) || [],
                r = 0; r < h.length; r++)
                    d = h[r],
                    (l = (g.match(th(d, e)) || [])[0]) && (0 < (u = g.substr(0, g.indexOf(l))).length && c(e).unusedInput.push(u),
                    g = g.slice(g.indexOf(l) + l.length),
                    $ += l.length),
                    N[d] ? (l ? c(e).empty = !1 : c(e).unusedTokens.push(d),
                    f = d,
                    m = e,
                    null != (p = l) && o(td, f) && td[f](p, m._a, m, f)) : e._strict && !l && c(e).unusedTokens.push(d);
                c(e).charsLeftOver = v - $,
                0 < g.length && c(e).unusedInput.push(g),
                e._a[tv] <= 12 && !0 === c(e).bigHour && 0 < e._a[tv] && (c(e).bigHour = void 0),
                c(e).parsedDateParts = e._a.slice(0),
                c(e).meridiem = e._meridiem,
                e._a[tv] = (i = e._locale,
                s = e._a[tv],
                null == (n = e._meridiem) ? s : null != i.meridiemHour ? i.meridiemHour(s, n) : (null != i.isPM && ((a = i.isPM(n)) && s < 12 && (s += 12),
                a || 12 !== s || (s = 0)),
                s)),
                es(e),
                ee(e)
    ...
    function eg(o) {
        var h, f, m, $, b = o._i, y = o._f;
        return o._locale = o._locale || et(o._l),
        null === b || void 0 === y && "" === b ? u({
            nullInput: !0
        }) : ("string" == typeof b && (o._i = b = o._locale.preparse(b)),
        v(b) ? new g(ee(b)) : (a(b) ? o._d = b : e(y) ? function(t) {
            var e, i, s, n, a;
            if (0 === t._f.length)
                return c(t).invalidFormat = !0,
                t._d = new Date(NaN);
            for (n = 0; n < t._f.length; n++)
                ...
                e._f = t._f[n],
                em(e),
                d(e) && (a += c(e).charsLeftOver,
                a += 10 * c(e).unusedTokens.length,
                c(e).score = a,
                (null == s || a < s) && (s = a,
                i = e));
            l(t, i || e)
        }(o) : y ? em(o) : s(f = (h = o)._i) ? h._d = new Date(t.now()) : a(f) ? h._d = new Date(f.valueOf()) : "string" == typeof f ? (m = h,
        null === ($ = eh.exec(m._i)) ? (ec(m),
        !1 === m._isValid && (delete m._isValid,
        ep(m),
        !1 === m._isValid && (delete m._isValid,
        t.createFromInputFallback(m)))) : m._d = new Date(+$[1])) : e(f) ? (h._a = r(f.slice(0), function(t) {
        ...
        }(h) : n(f) ? h._d = new Date(f) : t.createFromInputFallback(h),
        d(o) || (o._d = null),
        o))
    }
    function ev(t, s, n, a, r) {
        var o, l = {};
        return !0 !== n && !1 !== n || (a = n,
        n = void 0),
        (i(t) && function(t) {
        ...
        l._f = s,
        l._strict = a,
        (o = new g(ee(eg(l))))._nextDay && (o.add(1, "d"),
        o._nextDay = void 0),
        o
    }
    function e8(t, e, i, s) {
    ...
    t.RFC_2822 = function() {}
    ;
    var e$ = _("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
        var t = e8.apply(null, arguments);
        return this.isValid() && t.isValid() ? t < this ? this : t : u()
    })
      , eb = _("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
        var t = e8.apply(null, arguments);
    ...
    function e_(t) {
        ...
        this._isValid = function(t) {
            for (var e in t)
                if (-1 === tD.call(ew, e) || null != t[e] && isNaN(t[e]))
                    return !1;
            for (var i = !1, s = 0; s < ew.length; ++s)
                if (t[ew[s]]) {
                    if (i)
                        return !1;
                    parseFloat(t[ew[s]]) !== b(t[ew[s]]) && (i = !0)
                }
            return !0
        }(e),
        this._milliseconds = +c + 1e3 * h + 6e4 * l + 1e3 * o * 3600,
        this._days = +r + 7 * a,
    ...
    function eS(t, e) {
        ...
        if (null === i)
            return null;
        var s = ((i[i.length - 1] || []) + "").match(ex) || ["-", 0, 0]
          , n = 60 * s[1] + b(s[2]);
    ...
    function eP(e, i) {
        ...
        n = (v(e) || a(e) ? e.valueOf() : e8(e).valueOf()) - s.valueOf(),
    ...
    function eI(t, e) {
        var i, s, a, r, l, h, c = t, d = null;
        return ek(t) ? c = {
            ms: t._milliseconds,
            d: t._days,
            M: t._months
        } : n(t) ? (c = {},
        e ? c[e] = t : c.milliseconds = t) : (d = eA.exec(t)) ? (i = "-" === d[1] ? -1 : 1,
        c = {
            y: 0,
            d: b(d[tg]) * i,
            h: b(d[tv]) * i,
        ...
        c = {
            ...
            m: eO(d[7], i),
            s: eO(d[8], i)
        }) : null == c ? c = {} : "object" == typeof c && ("from"in c || "to"in c) && (a = (r = e8(c.from),
        l = e8(c.to),
        r.isValid() && l.isValid() ? (l = eP(l, r),
        r.isBefore(l) ? h = eF(r, l) : ((h = eF(l, r)).milliseconds = -h.milliseconds,
        h.months = -h.months),
        h) : {
            milliseconds: 0,
            months: 0
        ...
        c.M = a.months),
        s = new e_(c),
        ek(t) && o(t, "_locale") && (s._locale = t._locale),
        s
    }
    function eO(t, e) {
    ...
    function e0(t, e) {
        return function(i, s) {
            var n;
            return null === s || isNaN(+s) || (S(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
            n = i,
            i = s,
            s = n),
            eY(this, eI(i = "string" == typeof i ? +i : i, s), t),
            this
        }
    }
    function eY(e, i, s, n) {
        ...
        o && tI(e, tS(e, "Month") + o * s),
        r && tP(e, "Date", tS(e, "Date") + r * s),
        a && e._d.setTime(e._d.valueOf() + a * s),
        n && t.updateOffset(e, r || o))
    }
    eI.fn = e_.prototype,
    eI.invalid = function() {
        return eI(NaN)
    ...
    function eW(t) {
        var e;
        return void 0 === t ? this._locale._abbr : (null != (e = et(t)) && (this._locale = e),
        this)
    }
    t.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ",
    t.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
    var eN = _("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(t) {
    ...
    function ej(t, e, i) {
        return t < 100 && 0 <= t ? new Date(t + 400,e,i) - e9 : new Date(t,e,i).valueOf()
    }
    function eB(t, e, i) {
        return t < 100 && 0 <= t ? Date.UTC(t + 400, e, i) - e9 : Date.UTC(t, e, i)
    }
    function eq(t, e) {
        R(0, [t, t.length], 0, e)
    }
    function e1(t, e, i, s, n) {
        var a;
        return null == t ? tW(this, s, n).year : ((a = tN(t, s, n)) < e && (e = a),
        (function(t, e, i, s, n) {
            var a = tH(t, e, i, s, n)
              , r = tL(a.year, 0, a.dayOfYear);
    ...
    tl("GGGGG", te, G),
    tl("ggggg", te, G),
    tf(["gggg", "ggggg", "GGGG", "GGGGG"], function(t, e, i, s) {
        e[s.substr(0, 2)] = b(t)
    }),
    tf(["gg", "GG"], function(e, i, s, n) {
    ...
    tl("SS", J, V),
    tl("SSS", J, U),
    e7 = "SSSS"; e7.length <= 9; e7 += "S")
        tl(e7, ti);
    function e5(t, e) {
        e[tb] = b(1e3 * ("0." + t))
    }
    for (e7 = "S"; e7.length <= 9; e7 += "S")
        tu(e7, e5);
    var e4 = tx("Milliseconds", !1);
    R("z", 0, 0, "zoneAbbr"),
    R("zz", 0, 0, "zoneName");
    var e6 = g.prototype;
    function eK(t) {
    ...
    e6.add = eL,
    e6.calendar = function(e, i) {
        var s = e || e8()
          , n = eP(s, this).startOf("day")
          , a = t.calendarFormat(this, n) || "sameElse"
          , r = i && (P(i[a]) ? i[a].call(this, s) : i[a]);
        return this.format(r || this.localeData().calendar(a, this, e8(s)))
    }
    ,
    e6.clone = function() {
        return new g(this)
    ...
    ,
    e6.diff = function(t, e, i) {
        var s, n, a;
        if (!this.isValid() || !(s = eP(t, this)).isValid())
            return NaN;
    ...
    e6.endOf = function(e) {
        ...
        case "week":
            ...
            break;
        case "isoWeek":
            i = s(this.year(), this.month(), this.date() - (this.isoWeekday() - 1) + 7) - 1;
            break;
        case "day":
        case "date":
        ...
        case "hour":
            i = this._d.valueOf(),
            i += 36e5 - e3(i + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) - 1;
            break;
        case "minute":
            i = this._d.valueOf(),
            i += 6e4 - e3(i, 6e4) - 1;
        ...
        return this._d.setTime(i),
        t.updateOffset(this, !0),
        this
    }
    ,
    e6.format = function(e) {
        e || (e = this.isUtc() ? t.defaultFormatUtc : t.defaultFormat);
        var i = j(this, e);
        return this.localeData().postformat(i)
    }
    ,
    e6.from = function(t, e) {
        return this.isValid() && (v(t) && t.isValid() || e8(t).isValid()) ? eI({
            to: this,
            from: t
        }).locale(this.locale()).humanize(!e) : this.localeData().invalidDate()
    }
    ,
    e6.fromNow = function(t) {
        return this.from(e8(), t)
    }
    ,
    e6.to = function(t, e) {
        return this.isValid() && (v(t) && t.isValid() || e8(t).isValid()) ? eI({
    ...
    ,
    e6.invalidAt = function() {
        return c(this).overflow
    }
    ,
    e6.isAfter = function(t, e) {
        var i = v(t) ? t : e8(t);
        return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = I(e) || "millisecond") ? this.valueOf() > i.valueOf() : i.valueOf() < this.clone().startOf(e).valueOf())
    }
    ,
    e6.isBefore = function(t, e) {
        var i = v(t) ? t : e8(t);
        return !(!this.isValid() || !i.isValid()) && ("millisecond" === (e = I(e) || "millisecond") ? this.valueOf() < i.valueOf() : this.clone().endOf(e).valueOf() < i.valueOf())
    }
    ,
    e6.isBetween = function(t, e, i, s) {
        var n = v(t) ? t : e8(t)
          , a = v(e) ? e : e8(e);
        return !!(this.isValid() && n.isValid() && a.isValid()) && ("(" === (s = s || "()")[0] ? this.isAfter(n, i) : !this.isBefore(n, i)) && (")" === s[1] ? this.isBefore(a, i) : !this.isAfter(a, i))
    }
    ,
    e6.isSame = function(t, e) {
        var i, s = v(t) ? t : e8(t);
    ...
    ,
    e6.isSameOrAfter = function(t, e) {
        return this.isSame(t, e) || this.isAfter(t, e)
    }
    ,
    e6.isSameOrBefore = function(t, e) {
    ...
    e6.set = function(t, e) {
        if ("object" == typeof t)
            for (var i = function(t) {
                ...
                e
            }(t = O(t)), s = 0; s < i.length; s++)
                this[i[s].unit](t[i[s].unit]);
        else if (P(this[t = I(t)]))
            return this[t](e);
        return this
    }
    ,
    e6.startOf = function(e) {
        if (void 0 === (e = I(e)) || "millisecond" === e || !this.isValid())
            return this;
        var i, s = this._isUTC ? eB : ej;
        switch (e) {
        ...
        case "hour":
            i = this._d.valueOf(),
            i -= e3(i + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5);
            break;
        case "minute":
            i = this._d.valueOf(),
            i -= e3(i, 6e4);
    ...
    ,
    e6.toISOString = function(t) {
        if (!this.isValid())
            return null;
        var e = !0 !== t
          , i = e ? this.clone().utc() : this;
        return 0 > i.year() || 9999 < i.year() ? j(i, e ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : P(Date.prototype.toISOString) ? e ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", j(i, "Z")) : j(i, e ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
    }
    ,
    e6.inspect = function() {
        if (!this.isValid())
    ...
    ,
    e6.year = tC,
    e6.isLeapYear = function() {
        return tk(this.year())
    }
    ,
    e6.weekYear = function(t) {
        return e1.call(this, t, this.week(), this.weekday(), this.localeData()._week.dow, this.localeData()._week.doy)
    }
    ,
    e6.isoWeekYear = function(t) {
        return e1.call(this, t, this.isoWeek(), this.isoWeekday(), 1, 4)
    }
    ,
    e6.quarter = e6.quarters = function(t) {
        return null == t ? Math.ceil((this.month() + 1) / 3) : this.month(3 * (t - 1) + this.month() % 3)
    }
    ,
    e6.month = tO,
    e6.daysInMonth = function() {
        return tT(this.year(), this.month())
    }
    ,
    e6.week = e6.weeks = function(t) {
        var e = this.localeData().week(this);
        return null == t ? e : this.add(7 * (t - e), "d")
    }
    ,
    e6.isoWeek = e6.isoWeeks = function(t) {
        var e = tW(this, 1, 4).week;
        return null == t ? e : this.add(7 * (t - e), "d")
    }
    ,
    e6.weeksInYear = function() {
        var t = this.localeData()._week;
        return tN(this.year(), t.dow, t.doy)
    }
    ,
    e6.isoWeeksInYear = function() {
        return tN(this.year(), 1, 4)
    }
    ,
    e6.date = eV,
    e6.day = e6.days = function(t) {
        if (!this.isValid())
    ...
    ,
    e6.dayOfYear = function(t) {
        var e = Math.round((this.clone().startOf("day") - this.clone().startOf("year")) / 864e5) + 1;
        return null == t ? e : this.add(t - e, "d")
    }
    ,
    e6.hour = e6.hours = t4,
    e6.minute = e6.minutes = e2,
    e6.second = e6.seconds = eU,
    e6.millisecond = e6.milliseconds = e4,
    e6.utcOffset = function(e, i, s) {
        ...
        if ("string" == typeof e) {
            ...
            16 > Math.abs(e) && !s && (e *= 60);
        return !this._isUTC && i && (n = eT(this)),
        this._offset = e,
        this._isUTC = !0,
        null != n && this.add(n, "m"),
        a !== e && (!i || this._changeInProgress ? eY(this, eI(e - a, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
        t.updateOffset(this, !0),
    ...
    e6.local = function(t) {
        ...
        this._isUTC = !1,
        t && this.subtract(eT(this), "m")),
        this
    }
    ,
    e6.parseZone = function() {
        if (null != this._tzm)
    ...
    ,
    e6.hasAlignedHourOffset = function(t) {
        return !!this.isValid() && (t = t ? e8(t).utcOffset() : 0,
    ...
    ,
    e6.isUtcOffset = function() {
        return !!this.isValid() && this._isUTC
    }
    ,
    e6.isUtc = eM,
    e6.isUTC = eM,
    e6.zoneAbbr = function() {
        return this._isUTC ? "UTC" : ""
    }
    ,
    e6.zoneName = function() {
        return this._isUTC ? "Coordinated Universal Time" : ""
    }
    ,
    e6.dates = _("dates accessor is deprecated. Use date instead.", eV),
    e6.months = _("months accessor is deprecated. Use month instead", tO),
    e6.years = _("years accessor is deprecated. Use year instead", tC),
    e6.zone = _("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(t, e) {
        return null != t ? ("string" != typeof t && (t = -t),
        this.utcOffset(t, e),
        this) : -this.utcOffset()
    }),
    e6.isDSTShifted = _("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function() {
        if (!s(this._isDSTShifted))
            return this._isDSTShifted;
        var t = {};
        if (p(t, this),
        (t = eg(t))._a) {
            var e = t._isUTC ? h(t._a) : e8(t._a);
    ...
    function eQ(t, e, i, s) {
        e = ("boolean" == typeof t ? n(e) && (i = e,
        e = void 0) : (e = t,
        t = !1,
        n(i = e) && (i = e,
        e = void 0)),
        e || "");
        var a, r = et(), o = t ? r._week.dow : 0;
        if (null != i)
            return eX(e, (i + o) % 7, s, "day");
        var l = [];
        for (a = 0; a < 7; a++)
            l[a] = eX(e, (a + o) % 7, s, "day");
        return l
    }
    eG.calendar = function(t, e, i) {
        var s = this._calendar[t] || this._calendar.sameElse;
        return P(s) ? s.call(e, i) : s
    }
    ,
    eG.longDateFormat = function(t) {
    ...
    ,
    eG.invalidDate = function() {
        return this._invalidDate
    }
    ,
    eG.ordinal = function(t) {
        return this._ordinal.replace("%d", t)
    }
    ,
    eG.preparse = eK,
    eG.postformat = eK,
    eG.relativeTime = function(t, e, i, s) {
        var n = this._relativeTime[i];
        return P(n) ? n(t, e, i, s) : n.replace(/%d/i, t)
    }
    ,
    eG.pastFuture = function(t, e) {
    ...
    eG.set = function(t) {
        var e, i;
        for (i in t)
            P(e = t[i]) ? this[i] = e : this["_" + i] = e;
        this._config = t,
        this._dayOfMonthOrdinalParseLenient = RegExp((this._dayOfMonthOrdinalParse.source || this._ordinalParse.source) + "|" + /\d{1,2}/.source)
    }
    ,
    eG.months = function(t, i) {
        return t ? e(this._months) ? this._months[t.month()] : this._months[(this._months.isFormat || tM).test(i) ? "format" : "standalone"][t.month()] : e(this._months) ? this._months : this._months.standalone
    }
    ,
    eG.monthsShort = function(t, i) {
        return t ? e(this._monthsShort) ? this._monthsShort[t.month()] : this._monthsShort[tM.test(i) ? "format" : "standalone"][t.month()] : e(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
    }
    ,
    eG.monthsParse = function(t, e, i) {
        var s, n, a;
        if (this._monthsParseExact)
            return (function(t, e, i) {
                var s, n, a, r = t.toLocaleLowerCase();
                ...
                return i ? "MMM" === e ? -1 !== (n = tD.call(this._shortMonthsParse, r)) ? n : null : -1 !== (n = tD.call(this._longMonthsParse, r)) ? n : null : "MMM" === e ? -1 !== (n = tD.call(this._shortMonthsParse, r)) ? n : -1 !== (n = tD.call(this._longMonthsParse, r)) ? n : null : -1 !== (n = tD.call(this._longMonthsParse, r)) ? n : -1 !== (n = tD.call(this._shortMonthsParse, r)) ? n : null
            }
            ).call(this, t, e, i);
        ...
        s = 0; s < 12; s++)
            if (n = h([2e3, s]),
            i && !this._longMonthsParse[s] && (this._longMonthsParse[s] = RegExp("^" + this.months(n, "").replace(".", "") + "$", "i"),
            this._shortMonthsParse[s] = RegExp("^" + this.monthsShort(n, "").replace(".", "") + "$", "i")),
            i || this._monthsParse[s] || (a = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""),
            this._monthsParse[s] = RegExp(a.replace(".", ""), "i")),
            i && "MMMM" === e && this._longMonthsParse[s].test(t) || i && "MMM" === e && this._shortMonthsParse[s].test(t) || !i && this._monthsParse[s].test(t))
                return s
    }
    ,
    eG.monthsRegex = function(t) {
        return this._monthsParseExact ? (o(this, "_monthsRegex") || tY.call(this),
        t ? this._monthsStrictRegex : this._monthsRegex) : (o(this, "_monthsRegex") || (this._monthsRegex = t0),
        this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
    }
    ,
    eG.monthsShortRegex = function(t) {
        return this._monthsParseExact ? (o(this, "_monthsRegex") || tY.call(this),
        t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (o(this, "_monthsShortRegex") || (this._monthsShortRegex = tF),
        this._monthsShortStrictRegex && t ? this._monthsShortStrictRegex : this._monthsShortRegex)
    }
    ,
    eG.week = function(t) {
        return tW(t, this._week.dow, this._week.doy).week
    }
    ,
    eG.firstDayOfYear = function() {
        return this._week.doy
    }
    ,
    eG.firstDayOfWeek = function() {
        return this._week.dow
    }
    ,
    eG.weekdays = function(t, i) {
        var s = e(this._weekdays) ? this._weekdays : this._weekdays[t && !0 !== t && this._weekdays.isFormat.test(i) ? "format" : "standalone"];
        return !0 === t ? tR(s, this._week.dow) : t ? s[t.day()] : s
    }
    ,
    eG.weekdaysMin = function(t) {
        return !0 === t ? tR(this._weekdaysMin, this._week.dow) : t ? this._weekdaysMin[t.day()] : this._weekdaysMin
    }
    ,
    eG.weekdaysShort = function(t) {
        return !0 === t ? tR(this._weekdaysShort, this._week.dow) : t ? this._weekdaysShort[t.day()] : this._weekdaysShort
    }
    ,
    eG.weekdaysParse = function(t, e, i) {
        var s, n, a;
        ...
        s = 0; s < 7; s++)
            if (n = h([2e3, 1]).day(s),
            i && !this._fullWeekdaysParse[s] && (this._fullWeekdaysParse[s] = RegExp("^" + this.weekdays(n, "").replace(".", "\\.?") + "$", "i"),
            ...
            this._weekdaysParse[s] = RegExp(a.replace(".", ""), "i")),
    ...
    ,
    eG.weekdaysRegex = function(t) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || tV.call(this),
        t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (o(this, "_weekdaysRegex") || (this._weekdaysRegex = tB),
        this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }
    ,
    eG.weekdaysShortRegex = function(t) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || tV.call(this),
        t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (o(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = tq),
        this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }
    ,
    eG.weekdaysMinRegex = function(t) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || tV.call(this),
        t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (o(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = t1),
    ...
    t.lang = _("moment.lang is deprecated. Use moment.locale instead.", tQ),
    t.langData = _("moment.langData is deprecated. Use moment.localeData instead.", et);
    var eJ = Math.abs;
    function it(t, e, i, s) {
        var n = eI(e, i);
        return t._milliseconds += s * n._milliseconds,
        t._days += s * n._days,
    ...
    function iS() {
        ...
        var t, e, i = iC(this._milliseconds) / 1e3, s = iC(this._days), n = iC(this._months);
        e = $((t = $(i / 60)) / 60),
        i %= 60,
        t %= 60;
        var a = $(n / 12)
        ...
        if (!d)
            return "P0D";
        var u = d < 0 ? "-" : ""
          , f = ix(this._months) !== ix(d) ? "-" : ""
          , p = ix(this._days) !== ix(d) ? "-" : ""
          , m = ix(this._milliseconds) !== ix(d) ? "-" : "";
        return u + "P" + (a ? f + a + "Y" : "") + (r ? f + r + "M" : "") + (o ? p + o + "D" : "") + (l || h || c ? "T" : "") + (l ? m + l + "H" : "") + (h ? m + h + "M" : "") + (c ? m + c + "S" : "")
    }
    var iP = e_.prototype;
    return iP.isValid = function() {
        return this._isValid
    }
    ,
    iP.abs = function() {
        var t = this._data;
        return this._milliseconds = eJ(this._milliseconds),
        this._days = eJ(this._days),
        this._months = eJ(this._months),
        t.milliseconds = eJ(t.milliseconds),
        t.seconds = eJ(t.seconds),
        t.minutes = eJ(t.minutes),
        t.hours = eJ(t.hours),
        t.months = eJ(t.months),
        t.years = eJ(t.years),
        this
    }
    ,
    ...
    iP.as = function(t) {
        ...
        if ("month" === (t = I(t)) || "quarter" === t || "year" === t)
            switch (e = this._days + s / 864e5,
            i = this._months + ii(e),
            t) {
            case "month":
                return i;
            ...
            switch (e = this._days + Math.round(is(this._months)),
            t) {
            case "week":
                return e / 7 + s / 6048e5;
            case "day":
    ...
    ,
    iP._bubble = function() {
        var t, e, i, s, n, a = this._milliseconds, r = this._days, o = this._months, l = this._data;
        return 0 <= a && 0 <= r && 0 <= o || a <= 0 && r <= 0 && o <= 0 || (a += 864e5 * ie(is(o) + r),
        o = r = 0),
    ...
    iP.months = iw,
    iP.years = i_,
    iP.humanize = function(t) {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e, i, s, n, a, r, o, l, h, c, d, u = this.localeData(), f = (i = !t,
        s = u,
        n = eI(e = this).abs(),
        a = ik(n.as("s")),
        r = ik(n.as("m")),
        ...
        h = ik(n.as("M")),
        c = ik(n.as("y")),
        (d = a <= iD.ss && ["s", a] || a < iD.s && ["ss", a] || r <= 1 && ["m"] || r < iD.m && ["mm", r] || o <= 1 && ["h"] || o < iD.h && ["hh", o] || l <= 1 && ["d"] || l < iD.d && ["dd", l] || h <= 1 && ["M"] || h < iD.M && ["MM", h] || c <= 1 && ["y"] || ["yy", c])[2] = i,
        d[3] = 0 < +e,
        d[4] = s,
        (function(t, e, i, s, n) {
        ...
        return t && (f = u.pastFuture(+this, f)),
        u.postformat(f)
    }
    ,
    iP.toISOString = iS,
    ...
    iP.locale = eW,
    iP.localeData = eR,
    iP.toIsoString = _("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", iS),
    iP.lang = eN,
    R("X", 0, 0, "unix"),
    R("x", 0, 0, "valueOf"),
    tl("x", ts),
    ...
    t.fn = e6,
    t.min = function() {
        return ey("isBefore", [].slice.call(arguments, 0))
    }
    ,
    t.max = function() {
        return ey("isAfter", [].slice.call(arguments, 0))
    }
    ,
    t.now = function() {
    ...
    t.weekdays = function(t, e, i) {
        return eQ(t, e, i, "weekdays")
    }
    ,
    t.parseZone = function() {
        return e8.apply(null, arguments).parseZone()
    }
    ,
    t.localeData = et,
    t.isDuration = ek,
    t.monthsShort = function(t, e) {
        return eZ(t, e, "monthsShort")
    }
    ,
    t.weekdaysMin = function(t, e, i) {
        return eQ(t, e, i, "weekdaysMin")
    }
    ,
    t.defineLocale = tJ,
    t.updateLocale = function(t, e) {
        if (null != e) {
            var i, s, n = t6;
            null != (s = tZ(t)) && (n = s._config),
            (i = new M(e = T(n, e))).parentLocale = tK[t],
            tK[t] = i,
            tQ(t)
        } else
            null != tK[t] && (null != tK[t].parentLocale ? tK[t] = tK[t].parentLocale : null != tK[t] && delete tK[t]);
        return tK[t]
    }
    ,
    t.locales = function() {
    ...
    t.weekdaysShort = function(t, e, i) {
        return eQ(t, e, i, "weekdaysShort")
    }
    ,
    t.normalizeUnits = I,
    t.relativeTimeRounding = function(t) {
        return void 0 === t ? ik : "function" == typeof t && (ik = t,
        !0)
    }
    ,
    t.relativeTimeThreshold = function(t, e) {
        return void 0 !== iD[t] && (void 0 === e ? iD[t] : (iD[t] = e,
        "s" === t && (iD.ss = e - 1),
        !0))
    }
    ,
...
function(t, e) {
    ...
    var i = function(i, s, n) {
        ...
        "string" == typeof (s = e.extend(this.element.data(), s)).template || s.template instanceof e || (s.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
        ...
        "object" == typeof s.locale && ("string" == typeof s.locale.direction && (this.locale.direction = s.locale.direction),
        ...
        "string" == typeof s.locale.customRangeLabel)) {
            var a, r, o, l = document.createElement("textarea");
        ...
        "boolean" == typeof s.singleDatePicker && (this.singleDatePicker = s.singleDatePicker,
        ...
        if (void 0 === s.startDate && void 0 === s.endDate && e(this.element).is(":text")) {
            ...
            a = r = null,
            2 == u.length ? (a = t(u[0], this.locale.format),
            r = t(u[1], this.locale.format)) : this.singleDatePicker && "" !== d && (a = t(d, this.locale.format),
            r = t(d, this.locale.format)),
            null !== a && null !== r && (this.setStartDate(a),
            this.setEndDate(r))
        }
        if ("object" == typeof s.ranges) {
            for (o in s.ranges) {
                a = "string" == typeof s.ranges[o][0] ? t(s.ranges[o][0], this.locale.format) : t(s.ranges[o][0]),
                r = "string" == typeof s.ranges[o][1] ? t(s.ranges[o][1], this.locale.format) : t(s.ranges[o][1]),
                this.minDate && a.isBefore(this.minDate) && (a = this.minDate.clone());
                var f = this.maxDate;
                if (this.maxSpan && f && a.clone().add(this.maxSpan).isAfter(f) && (f = a.clone().add(this.maxSpan)),
                f && r.isAfter(f) && (r = f.clone()),
                !(this.minDate && r.isBefore(this.minDate, this.timepicker ? "minute" : "day") || f && a.isAfter(f, this.timepicker ? "minute" : "day"))) {
    ...
    return i.prototype = {
        ...
        renderCalendar: function(i) {
            var s, n, a = "left" == i ? this.leftCalendar : this.rightCalendar, r = a.month.month(), o = a.month.year(), l = a.month.hour(), h = a.month.minute(), c = a.month.second(), d = t([o, r]).daysInMonth(), u = t([o, r, 1]), f = t([o, r, d]), p = t(u).subtract(1, "month").month(), m = t(u).subtract(1, "month").year(), g = t([m, p]).daysInMonth(), v = u.day(), a = [];
            a.firstDay = u,
            a.lastDay = f;
            for (var $ = 0; $ < 6; $++)
                a[$] = [];
            var b = g - v + this.locale.firstDay + 1;
            b > g && (b -= 7),
            v == this.locale.firstDay && (b = g - 6);
            for (var y = t([m, p, b, 12, h, c]), $ = 0, s = 0, n = 0; $ < 42; $++,
            s++,
            y = t(y).add(24, "hour"))
                $ > 0 && s % 7 == 0 && (s = 0,
                n++),
                a[n][s] = y.clone().hour(l).minute(h).second(c),
                y.hour(12),
                this.minDate && a[n][s].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && a[n][s].isBefore(this.minDate) && "left" == i && (a[n][s] = this.minDate.clone()),
                this.maxDate && a[n][s].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && a[n][s].isAfter(this.maxDate) && "right" == i && (a[n][s] = this.maxDate.clone());
            "left" == i ? this.leftCalendar.calendar = a : this.rightCalendar.calendar = a;
            ...
            (!w || w.isBefore(a.firstDay)) && (!this.linkedCalendars || "left" == i) ? k += '<th class="prev available"><span></span></th>' : k += "<th></th>";
            var D = this.locale.monthNames[a[1][1].month()] + a[1][1].format(" YYYY");
            if (this.showDropdowns) {
                for (var C = a[1][1].month(), x = a[1][1].year(), S = _ && _.year() || this.maxYear, P = w && w.year() || this.minYear, T = x == P, M = x == S, A = '<select class="monthselect">', E = 0; E < 12; E++)
                    (!T || w && E >= w.month()) && (!M || _ && E <= _.month()) ? A += "<option value='" + E + "'" + (E === C ? " selected='selected'" : "") + ">" + this.locale.monthNames[E] + "</option>" : A += "<option value='" + E + "'" + (E === C ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[E] + "</option>";
                A += "</select>";
                for (var I = '<select class="yearselect">', O = P; O <= S; O++)
                    I += '<option value="' + O + '"' + (O === x ? ' selected="selected"' : "") + ">" + O + "</option>";
                I += "</select>",
                D = A + I
            }
            if (k += '<th colspan="5" class="month">' + D + "</th>",
            (!_ || _.isAfter(a.lastDay)) && (!this.linkedCalendars || "right" == i || this.singleDatePicker) ? k += '<th class="next available"><span></span></th>' : k += "<th></th>",
            k += "</tr>",
            k += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (k += '<th class="week">' + this.locale.weekLabel + "</th>"),
            ...
            null == this.endDate && this.maxSpan) {
                var F = this.startDate.clone().add(this.maxSpan).endOf("day");
                (!_ || F.isBefore(_)) && (_ = F)
            }
            for (var n = 0; n < 6; n++) {
                k += "<tr>",
                this.showWeekNumbers ? k += '<td class="week">' + a[n][0].week() + "</td>" : this.showISOWeekNumbers && (k += '<td class="week">' + a[n][0].isoWeek() + "</td>");
                for (var s = 0; s < 7; s++) {
                    var Y = [];
                    a[n][s].isSame(new Date, "day") && Y.push("today"),
                    a[n][s].isoWeekday() > 5 && Y.push("weekend"),
                    a[n][s].month() != a[1][1].month() && Y.push("off", "ends"),
                    this.minDate && a[n][s].isBefore(this.minDate, "day") && Y.push("off", "disabled"),
                    _ && a[n][s].isAfter(_, "day") && Y.push("off", "disabled"),
                    this.isInvalidDate(a[n][s]) && Y.push("off", "disabled"),
                    a[n][s].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && Y.push("active", "start-date"),
                    null != this.endDate && a[n][s].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && Y.push("active", "end-date"),
                    null != this.endDate && a[n][s] > this.startDate && a[n][s] < this.endDate && Y.push("in-range");
                    var L = this.isCustomDate(a[n][s]);
                    !1 !== L && ("string" == typeof L ? Y.push(L) : Array.prototype.push.apply(Y, L));
                    for (var z = "", H = !1, $ = 0; $ < Y.length; $++)
                        z += Y[$] + " ",
                        "disabled" == Y[$] && (H = !0);
                    H || (z += "available"),
                    k += '<td class="' + z.replace(/^\s+|\s+$/g, "") + '" data-title="r' + n + "c" + s + '">' + a[n][s].date() + "</td>"
                }
                k += "</tr>"
            }
            k += "</tbody>",
            k += "</table>",
            this.container.find(".drp-calendar." + i + " .calendar-table").html(k)
        },
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                var e, i, s, n = this.maxDate;
                if (this.maxSpan && (!this.maxDate || this.startDate.clone().add(this.maxSpan).isBefore(this.maxDate)) && (n = this.startDate.clone().add(this.maxSpan)),
                "left" == t)
                    ...
                    if ("" != a.html() && (i.hour(isNaN(i.hour()) ? a.find(".hourselect option:selected").val() : i.hour()),
                    i.minute(isNaN(i.minute()) ? a.find(".minuteselect option:selected").val() : i.minute()),
                    i.second(isNaN(i.second()) ? a.find(".secondselect option:selected").val() : i.second()),
                    !this.timePicker24Hour)) {
                        var r = a.find(".ampmselect option:selected").val();
                ...
                for (var o = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, h = o; h <= l; h++) {
                    var c = h;
                    this.timePicker24Hour || (c = i.hour() >= 12 ? 12 == h ? 12 : h + 12 : 12 == h ? 0 : h);
                    var d = i.clone().hour(c)
                      , u = !1;
                    s && d.minute(59).isBefore(s) && (u = !0),
                    n && d.minute(0).isAfter(n) && (u = !0),
                    c != i.hour() || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + h + "</option>" : e += '<option value="' + h + '">' + h + "</option>" : e += '<option value="' + h + '" selected="selected">' + h + "</option>"
                }
                e += "</select> ",
                ...
                for (var h = 0; h < 60; h += this.timePickerIncrement) {
                    ...
                    i.minute() != h || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + f + "</option>" : e += '<option value="' + h + '">' + f + "</option>" : e += '<option value="' + h + '" selected="selected">' + f + "</option>"
                }
                if (e += "</select> ",
                this.timePickerSeconds) {
                    ...
                    for (var h = 0; h < 60; h++) {
                        ...
                        s && d.isBefore(s) && (u = !0),
                        n && d.isAfter(n) && (u = !0),
                        i.second() != h || u ? u ? e += '<option value="' + h + '" disabled="disabled" class="disabled">' + f + "</option>" : e += '<option value="' + h + '">' + f + "</option>" : e += '<option value="' + h + '" selected="selected">' + f + "</option>"
                    }
                    e += "</select> "
                }
                if (!this.timePicker24Hour) {
                    ...
                    var p = ""
                      , m = "";
                    s && i.clone().hour(12).minute(0).second(0).isBefore(s) && (p = ' disabled="disabled" class="disabled"'),
                    n && i.clone().hour(0).minute(0).second(0).isAfter(n) && (m = ' disabled="disabled" class="disabled"'),
                    i.hour() >= 12 ? e += '<option value="AM"' + p + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>" : e += '<option value="AM" selected="selected"' + p + '>AM</option><option value="PM"' + m + ">PM</option>",
                    e += "</select>"
                }
        ...
        move: function() {
            var t, i = {
                top: 0,
                left: 0
            }, s = this.drops, n = e(window).width();
            switch (this.parentEl.is("body") || (i = {
            ...
            s) {
            case "auto":
                (t = this.element.offset().top + this.element.outerHeight() - i.top) + this.container.outerHeight() >= this.parentEl[0].scrollHeight && (t = this.element.offset().top - this.container.outerHeight() - i.top,
                s = "up");
                break;
            case "up":
            ...
            if (this.container.toggleClass("drop-up", "up" == s),
            "left" == this.opens) {
                var r = n - this.element.offset().left - this.element.outerWidth();
                a + r > e(window).width() ? this.container.css({
                    top: t,
                    right: "auto",
                    left: 9
                }) : this.container.css({
                ...
                var o = this.element.offset().left - i.left + this.element.outerWidth() / 2 - a / 2;
                o < 0 ? this.container.css({
                    top: t,
                    right: "auto",
                    left: 9
                }) : o + a > e(window).width() ? this.container.css({
                    top: t,
                    left: "auto",
                    right: 0
                }) : this.container.css({
                ...
                var o = this.element.offset().left - i.left;
                o + a > e(window).width() ? this.container.css({
                    top: t,
                    left: "auto",
                    right: 0
        ...
        outsideClick: function(t) {
            var i = e(t.target);
            "focusin" == t.type || i.closest(this.element).length || i.closest(this.container).length || i.closest(".calendar-table").length || (this.hide(),
        ...
        hoverDate: function(t) {
            if (e(t.target).hasClass("available")) {
                var i, s = e(t.target).attr("data-title"), n = s.substr(1, 1), a = s.substr(3, 1), r = e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[n][a] : this.rightCalendar.calendar[n][a], o = this.leftCalendar, l = this.rightCalendar, h = this.startDate;
                this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, i) {
                    if (!e(i).hasClass("week")) {
                        var s, n = e(i).attr("data-title"), a = n.substr(1, 1), c = n.substr(3, 1), d = e(i).parents(".drp-calendar").hasClass("left") ? o.calendar[a][c] : l.calendar[a][c];
                        d.isAfter(h) && d.isBefore(r) || d.isSame(r, "day") ? e(i).addClass("in-range") : e(i).removeClass("in-range")
                    }
                })
            }
        },
        clickDate: function(t) {
            if (e(t.target).hasClass("available")) {
                var i, s = e(t.target).attr("data-title"), n = s.substr(1, 1), a = s.substr(3, 1), r = e(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.calendar[n][a] : this.rightCalendar.calendar[n][a];
                if (this.endDate || r.isBefore(this.startDate, "day")) {
                    if (this.timePicker) {
                        ...
                        isNaN(h) && (h = parseInt(this.container.find(".left .minuteselect option:last").val(), 10));
                        var c = this.timePickerSeconds ? parseInt(this.container.find(".left .secondselect").val(), 10) : 0;
                    ...
                    if (this.timePicker) {
                        ...
                        isNaN(h) && (h = parseInt(this.container.find(".right .minuteselect option:last").val(), 10));
                        var c = this.timePickerSeconds ? parseInt(this.container.find(".right .secondselect").val(), 10) : 0;
                        r = r.clone().hour(o).minute(h).second(c)
                    }
        ...
        monthOrYearChanged: function(t) {
            ...
            !i && (r < this.startDate.year() || r == this.startDate.year() && a < this.startDate.month()) && (a = this.startDate.month(),
            r = this.startDate.year()),
            this.minDate && (r < this.minDate.year() || r == this.minDate.year() && a < this.minDate.month()) && (a = this.minDate.month(),
            r = this.minDate.year()),
            this.maxDate && (r > this.maxDate.year() || r == this.maxDate.year() && a > this.maxDate.month()) && (a = this.maxDate.month(),
            r = this.maxDate.year()),
            i ? (this.leftCalendar.month.month(a).year(r),
            this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(a).year(r),
        ...
        timeChanged: function(t) {
            ...
            isNaN(a) && (a = parseInt(i.find(".minuteselect option:last").val(), 10));
            var r = this.timePickerSeconds ? parseInt(i.find(".secondselect").val(), 10) : 0;
            if (!this.timePicker24Hour) {
                var o = i.find(".ampmselect").val();
                "PM" === o && n < 12 && (n += 12),
                "AM" === o && 12 === n && (n = 0)
            }
            if (s) {
